...
triggerNewPriceToastOpen.click()}function g(e){console.log("loadInfoRequests");let t=document.getElementById("infoRequestBidTemplate").cloneNode(!0),n=document.getElementById("infoRequestMeasurementsTemplate").cloneNode(!0),i=document.getElementById("infoRequestLongerPeriodTemplate").cloneNode(!0),o=document.getElementById("infoRequestImagesTemplate").cloneNode(!0),r=document.getElementById("infoRequestValuationTemplate").cloneNode(!0),s=document.getElementById("infoRequestsList");s.replaceChildren(),(e||[]).forEach(e=>{let l=e.id,p=e.infoRequests,g=e.status,y=e.brand.replace(/'/g,""),v=e.minPriceEstimate,h=e.maxPriceEstimate,x=e?.infoRequests?.price?.response==="Denied",E=e.archived,b=e.category,B=(0,a.itemCoverImage)(e);void 0==E&&"Unsold"!==g&&"Sold"!==g&&p&&function(){for(let e in p)if(p[e]?.status==="Active"){let a=p[e].description;// PRICE REQUEST
if(a&&(a=a.replace(/'/g,"")),"price"===e){let t=p[e].type,n=r.cloneNode(!0);n.id=`infoRequestPrice-${l}`,n.querySelector(".img-container").style.backgroundImage=`url('${B}')`,n.querySelector("a .pricebuttontext").innerText="Se prisf\xf6rslag",n.querySelector(".text-block-72").innerText="Vill du s\xe4nka priset och f\xe5 det s\xe5lt?",s.appendChild(n),"New"===g&&"Adjusted ML Valuation"!==t?(n.querySelector("a .pricebuttontext").innerText="Se v\xe4rdering",n.querySelector(".text-block-72").innerText="Vill du s\xe4lja till v\xe5r v\xe4rdering?",n.querySelector("a").href=`/item-valuation?id=${l}`):setTimeout(()=>{let n=p[e].maxPrice,i=p[e].minPrice;document.querySelector(`#infoRequestPrice-${l} a`).addEventListener("click",async()=>{await f(l,g,n,i,y,a,b,t,h,v)})},0)}// MEASUREMENTS REQUEST
if("measurements"===e){let e=n.cloneNode(!0);e.id=`infoRequestMeasurements-${l}`,e.querySelector(".img-container").style.backgroundImage=`url('${B}')`,s.appendChild(e),setTimeout(()=>{document.querySelector(`#infoRequestMeasurements-${l} a`).addEventListener("click",async()=>{await c(l,a)})},0)}// IMAGES REQUEST
if("images"===e){let e=o.cloneNode(!0);e.id=`infoRequestImages-${l}`,e.querySelector(".img-container").style.backgroundImage=`url('${B}')`,e.querySelector("a").href=`/edit-item?id=${l}`,s.appendChild(e)}// LONGER PERIOD REQUEST
if("longerPeriod"===e){let e=i.cloneNode(!0);e.id=`infoRequestLongerPeriod-${l}`,e.querySelector(".img-container").style.backgroundImage=`url('${B}')`,s.appendChild(e),setTimeout(()=>{document.querySelector(`#infoRequestLongerPeriod-${l} a`).addEventListener("click",async()=>{await u(l,y,v,x)})},0)}// BID REQUEST
if("bid"===e){let n=p[e].expires,i=new Date,o=d(n);if(// Only show bid request if it hasn't expired
console.log("Expired?: ",o>i),o>i){console.log("We try to show it!");let i=t.cloneNode(!0);i.id=`infoRequestBid-${l}`,i.querySelector(".img-container").style.backgroundImage=`url('${B}')`,s.appendChild(i),setTimeout(()=>{document.querySelector(`#infoRequestBid-${l} a`).addEventListener("click",async()=>{let t=p[e].price;await m(l,v,t,n)})},0)}}s.children.length>0&&(infoRequestsDiv.style.display="block")}}()});/*
...
i.export(n,"closeMenuWithAnimation",()=>p),i.export(n,"setupMenuHandlers",()=>f),// Toast animation functions
i.export(n,"animateOpenToast",()=>g),i.export(n,"animateCloseToast",()=>y),i.export(n,"hideInfoRequestCard",()=>v)},{"@parcel/transformer-js/src/esmodule-helpers.js":"bNgzC"}],bNgzC:[function(e,t,n){n.interopDefault=function(e){return e&&e.__esModule?e:{default:e}},n.defineInteropFlag=function(e){Object.defineProperty(e,"__esModule",{value:!0})},n.exportAll=function(e,t){return Object.keys(e).forEach(function(n){"default"===n||"__esModule"===n||t.hasOwnProperty(n)||Object.defineProperty(t,n,{enumerable:!0,get:function(){return e[n]}})}),t},n.export=function(e,t,n){Object.defineProperty(e,t,{enumerable:!0,get:n})}},{}]},["21npA"],"21npA","parcelRequire81ca")//# sourceMappingURL=infoRequestsFunctions.js.map
;
