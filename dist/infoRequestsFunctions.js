...
if("longerPeriod"===e){let e=n.cloneNode(!0);e.id=`infoRequestLongerPeriod-${d}`,e.querySelector(".img-container").style.backgroundImage=`url('${h}')`,o.appendChild(e),setTimeout(()=>{document.querySelector(`#infoRequestLongerPeriod-${d} a`).addEventListener("click",async()=>{await a(d,p,f,v)})},0)}infoRequestsDiv.style.display="block"}}()});/*
