...
r.export(n,"isValidSwedishSsn",()=>c),r.export(n,"formatPersonalId",()=>u),r.export(n,"itemCoverImage",()=>m),r.export(n,"shareCode",()=>p);let o="https://europe-west1-second-hand-helper.cloudfunctions.net/webApi";async function s(e,{data:t,method:n,requiresAuth:r,timeoutSec:i=20}={}){// const { data, method, requiresAuth, timeoutSec = 20 } = opts;
