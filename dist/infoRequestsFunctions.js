...
}),triggerLongerPeriodToastClose.click(),setTimeout(function(){location.reload()},300)}),triggerLongerPeriodToastOpen.click()}async function l(e,t,n,r,i){// Deny price
if(console.log("storePriceResponse",e,t,n,r),"Accepted"===r&&await db.collection("items").doc(e).update({"infoRequests.price.status":"Resolved","infoRequests.price.response":"Accepted",maxPriceEstimate:t,minPriceEstimate:n}).then(function(){triggerNewPriceToastClose.click(),setTimeout(function(){location.reload()},300)}),"Denied"===r){let t={"infoRequests.price.status":"Resolved","infoRequests.price.response":"Denied"};"New"===i&&(t.archived=!0,t.willNotSell=!0),await db.collection("items").doc(e).update(t).then(function(){triggerNewPriceToastClose.click(),setTimeout(function(){location.reload()},300)})}}async function a(e,t,n,r,i,o,s,a,d,c){console.log("openNewPriceToast",e,t,n,r,i,o,s,a,d,c),previousMinPrice.style.display="none",previousMaxPrice.style.display="none",maxPriceDiv.style.display="block",minPriceDiv.style.display="block",// Set content of toast
newPriceToastTitle.innerHTML="Nytt l\xe4gsta pris",newPriceHeading.innerHTML=`${i}-plagg`;let u=s.toLowerCase();u&&"null"!==u&&(newPriceHeading.innerHTML=`${i}-${u}`),maxPrice.innerHTML=n,minPrice.innerHTML=r,d&&"null"!==d&&""!==d&&"undefined"!==d&&n!==d&&(previousMaxPrice.innerHTML=d,previousMaxPrice.style.display="block"),c&&"null"!==c&&""!==c&&"undefined"!==c&&r!==c&&(previousMinPrice.innerHTML=c,previousMinPrice.style.display="block"),acceptNewPriceButton.innerHTML="S\xe4lj med nytt pris",denyNewPriceButton.innerHTML="S\xe4nk ej","New"===t&&"Valuation"===a&&(newPriceToastTitle.innerHTML="V\xe4rdering",acceptNewPriceButton.innerHTML="S\xe4lj till v\xe4rdering",denyNewPriceButton.innerHTML="Avb\xf6j och avsluta"),"Adjusted ML Valuation"===a&&(newPriceToastTitle.innerHTML="Nytt prisintervall"),"Valuation"!==a&&"Adjusted ML Valuation"!==a&&(minPrice.innerHTML=`${r} kr`,maxPriceDiv.style.display="none"),o&&"undefined"!==o&&""!==o&&"null"!==o&&(newPriceText.innerHTML=o,descriptionDiv.style.display="block"),acceptNewPriceButton.addEventListener("click",()=>{l(e,n,r,"Accepted",t)}),denyNewPriceButton.addEventListener("click",()=>{l(e,n,r,"Denied",t)}),// Open toast
...
if(i&&(i=i.replace(/'/g,"")),"price"===e){let t=u[e].type,n=l.cloneNode(!0);n.id=`infoRequestPrice-${c}`,n.querySelector(".img-container").style.backgroundImage=`url('${h}')`,n.querySelector("a .pricebuttontext").innerText="Se prisf\xf6rslag",n.querySelector(".text-block-72").innerText="Vill du s\xe4nka priset och f\xe5 det s\xe5lt?",d.appendChild(n),"New"===m&&"Adjusted ML Valuation"!==t?(n.querySelector("a .pricebuttontext").innerText="Se v\xe4rdering",n.querySelector(".text-block-72").innerText="Vill du s\xe4lja till v\xe5r v\xe4rdering?",n.querySelector("a").href=`/item-valuation?id=${c}`):setTimeout(()=>{let n=u[e].maxPrice,r=u[e].minPrice;document.querySelector(`#infoRequestPrice-${c} a`).addEventListener("click",async()=>{await a(c,m,n,r,p,i,x,t,g,f)})},0)}// MEASUREMENTS REQUEST
...
r.export(n,"isValidSwedishSsn",()=>l),r.export(n,"formatPersonalId",()=>a),r.export(n,"itemCoverImage",()=>d),r.export(n,"shareCode",()=>c)},{"@parcel/transformer-js/src/esmodule-helpers.js":"bNgzC"}],bNgzC:[function(e,t,n){n.interopDefault=function(e){return e&&e.__esModule?e:{default:e}},n.defineInteropFlag=function(e){Object.defineProperty(e,"__esModule",{value:!0})},n.exportAll=function(e,t){return Object.keys(e).forEach(function(n){"default"===n||"__esModule"===n||t.hasOwnProperty(n)||Object.defineProperty(t,n,{enumerable:!0,get:function(){return e[n]}})}),t},n.export=function(e,t,n){Object.defineProperty(e,t,{enumerable:!0,get:n})}},{}]},["21npA"],"21npA","parcelRequire81ca")//# sourceMappingURL=infoRequestsFunctions.js.map
;
