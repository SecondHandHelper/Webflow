...
})({"cyjTZ":[function(require,module,exports) {
...
function loadRecentlySold() {
    const recentlySoldItems = (0, _general.callBackendApi)("/api/items/recentlySold");
...
function noCommissionCampaign() {
    ...
    } else if (campaignDateOk && !cookie.length && random <= 0.5) setCookie(cookieName, "commission", 7);
}
...
},{}]},["cyjTZ","3PNHe"], "3PNHe", "parcelRequire81ca")
