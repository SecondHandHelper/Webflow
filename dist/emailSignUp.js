...
})({"6rbKR":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 50619;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "338debb1158b626f";
"use strict";
...
},{}],"kV9zD":[function(require,module,exports) {
var _general = require("./general");
const campaignSignUpMain = async ()=>{
    try {
        document.getElementById("emailText").innerText = getParamsObject().email;
        const response = await (0, _general.callBackendApi)("/api/items/recommendationsSignup", {
            data: {
                email: getParamsObject().email
            },
            method: "PUT"
        });
        if (!response.ok) {
        ...
        document.getElementById("emailText").innerText = "N\xe5got gick fel";
    }
};
campaignSignUpMain();
...
},{}]},["6rbKR","kV9zD"], "kV9zD", "parcelRequire81ca")
