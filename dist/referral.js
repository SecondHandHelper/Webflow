...
})({"kdO2w":[function(require,module,exports,__globalThis) {
...
},{}],"evH6t":[function(require,module,exports,__globalThis) {
...
async function main() {
    ...
    if (user.current?.referralData?.referredUsers?.length > 0) document.getElementById('topStatsLoadingIcon').style.display = 'block';
    ...
    if (user.current?.referralData?.referredUsers?.length > 0) {
        ...
        callBackendApi('/api/users/referralStats', {
            requiresAuth: true
...
if (isMobile) {
    user.whenSet(main);
    if (!user.current && !params.has('app')) location.href = '/sign-in';
} else {
...
},{"./general":"lWrRo","qrcode":"lB7MY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lWrRo":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"c36bbcf663291acc":"6rMWz"}]},["kdO2w","evH6t"], "evH6t", "parcelRequire81ca")
