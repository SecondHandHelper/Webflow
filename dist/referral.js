...
let a=r.getSymbolTotalCodewords(t),s=d.getTotalCodewordsCount(t,n),l=a-s,u=d.getBlocksCount(t,n),f=a%u,h=u-f,g=Math.floor(a/u),m=Math.floor(l/u),p=m+1,y=g-m,E=new c(y),v=0,b=Array(u),B=Array(u),I=0,w=new Uint8Array(e.buffer);// Divide the buffer into the required number of blocks
...
for(o=0;o<I;o++)for(i=0;i<u;i++)o<b[i].length&&(C[A++]=b[i][o]);// Apped EC codewords
for(o=0;o<y;o++)for(i=0;i<u;i++)C[A++]=B[i][o];return C}(o,e,t))}(t,n,h),v=r.getSymbolSize(t),b=new a(v);return(// Add function modules
/**
 ...
 */function(e,t){let n={},o={start:{}},i=["start"];for(let a=0;a<e.length;a++){let s=e[a],l=[];for(let e=0;e<s.length;e++){let u=s[e],d=""+a+e;l.push(d),n[d]={node:u,lastCount:0},o[d]={};for(let e=0;e<i.length;e++){let a=i[e];n[a]&&n[a].node.mode===u.mode?(o[a][d]=g(n[a].lastCount+u.length,u.mode)-g(n[a].lastCount,u.mode),n[a].lastCount+=u.length):(n[a]&&(n[a].lastCount=u.length),o[a][d]=g(u.length,u.mode)+4+r.getCharCountIndicator(u.mode,t)// switch cost
...
d=f[a],(void 0===f[a]||d>u)&&(f[a]=u,h.push(a,u),c[a]=i));if(void 0!==n&&void 0===f[n])throw Error(["Could not find a path from ",t," to ",n,"."].join(""));return c},extract_shortest_path_from_predecessor_list:function(e,t){for(var n=[],r=t;r;)n.push(r),e[r],r=e[r];return n.reverse(),n},find_path:function(e,t,n){var o=r.single_source_shortest_paths(e,t,n);return r.extract_shortest_path_from_predecessor_list(o,n)},/**
