...
if(l&&"string"==typeof t)return l(t);var d=Error("Cannot find module '"+t+"'");throw d.code="MODULE_NOT_FOUND",d}f.resolve=function(n){var r=e[t][1][n];return null!=r?r:n},f.cache={};var c=s[t]=new u.Module(t);e[t][0].call(c.exports,f,c,c.exports,this)}return s[t].exports;function f(e){var t=f.resolve(e);return!1===t?{}:u(t)}}u.isParcelRequire=!0,u.Module=function(e){this.id=e,this.bundle=u,this.exports={}},u.modules=e,u.cache=s,u.parent=a,u.register=function(t,n){e[t]=[function(e,t){t.exports=n},{}]},Object.defineProperty(u,"root",{get:function(){return i[r]}}),i[r]=u;for(var d=0;d<t.length;d++)u(t[d]);if(n){// Expose entry point to Node, AMD or browser globals
// Based on https://github.com/ForbesLindesay/umd/blob/master/template.js
var c=u(n);// CommonJS
"object"==typeof exports&&"undefined"!=typeof module?module.exports=c:"function"==typeof define&&define.amd?define(function(){return c}):o&&(this[o]=c)}}({"7rA3f":[function(e,t,n){var r=e("@parcel/transformer-js/src/esmodule-helpers.js"),o=e("./general"),i=e("qrcode"),a=r.interopDefault(i);async function s(){console.log("referral main");let e=new URL(window.location).searchParams;if(!e.has("app")&&!user.current?.referralData?.referralCode)return location.href="/private";user.current?.maiCircle&&(document.getElementById("referralText").style.display="none",document.getElementById("referralTextMaiCircle").style.display="block");let t=user.current?.referralData?.referralCode;document.getElementById("referralCode").innerText=t||"",user.current?.referralData?.referredUsers?.length>0&&(document.getElementById("topStatsLoadingIcon").style.display="block"),document.getElementById("referralCode").innerText=user.current.referralData.referralCode,user.current?.referralData?.referredUsers?.length>0&&(//TOP STATS
document.getElementById("invitedFriends").innerText=user.current.referralData.referredUsers.length,document.getElementById("topStatsDiv").style.visibility="visible",document.getElementById("topStats").style.display="flex",document.getElementById("topStatsLoadingIcon").style.display="none")}let l=getParamsObject();if(shareReferralLinkButton.addEventListener("click",o.shareCode),document.getElementById("referralCode").innerText="",/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))user.whenSet(s),user.current||l.has("app")||(location.href="/sign-in");else{let e=document.getElementById("qrCanvas");e&&(0,a.default).toCanvas(e,window.location.href,function(e){e&&console.error(e),console.log("success!")})}},{"./general":"1tOWF",qrcode:"6s2CO","@parcel/transformer-js/src/esmodule-helpers.js":"bNgzC"}],"1tOWF":[function(e,t,n){var r=e("@parcel/transformer-js/src/esmodule-helpers.js");async function o(){try{try{// Delete session cookie
...
setTimeout(()=>{t.style.display="none"},300),document.getElementById("darkOverlay").classList.remove("active"))}function E(e){let t=document.getElementById(e);if(t){t.style.display="none";// Check if there are any remaining visible cards
...
r.export(n,"isValidSwedishSsn",()=>s),r.export(n,"formatPersonalId",()=>l),r.export(n,"itemCoverImage",()=>u),r.export(n,"shareCode",()=>d),// Channel bottom sheet
...
r.export(n,"animateOpenToast",()=>p),r.export(n,"animateCloseToast",()=>y),r.export(n,"hideInfoRequestCard",()=>E),// Make prepareMenu available globally for session cookie auto-login
...
t.exports=function(){return"function"==typeof Promise&&Promise.prototype&&Promise.prototype.then}},{}],e9qY0:[function(e,t,n){let r=e("4cf6a8173d9f3a2"),o=e("2ad62f61c352884c"),i=e("87d5a6270eb1dc26"),a=e("91abc94f777368cc"),s=e("9737c3939ab85d95"),l=e("cee3d371e219e45e"),u=e("8700c8c682afabf3"),d=e("65ad903a6ba3e"),c=e("1e8e447afb4d169c"),f=e("8a4a19af97836d80"),g=e("26720f9d94c9e268"),h=e("7b6429a248ecc51f"),m=e("1368d0fa14524351");/**
...
y=o.from(t.errorCorrectionLevel,o.M),n=f.from(t.version),g=u.from(t.maskPattern),t.toSJISFunc&&r.setToSJISFunction(t.toSJISFunc)),/**
...
let a=r.getSymbolTotalCodewords(e),s=d.getTotalCodewordsCount(e,t),l=(a-s)*8;// If the bit string is fewer than four bits shorter, add only the number of 0s that
...
let a=r.getSymbolTotalCodewords(t),s=d.getTotalCodewordsCount(t,n),l=a-s,u=d.getBlocksCount(t,n),f=a%u,g=u-f,h=Math.floor(a/u),m=Math.floor(l/u),p=m+1,y=h-m,E=new c(y),v=0,b=Array(u),I=Array(u),B=0,w=new Uint8Array(e.buffer);// Divide the buffer into the required number of blocks
for(let e=0;e<u;e++){let t=e<g?m:p;// extract a block of data from buffer
b[e]=w.slice(v,v+t),// Calculate EC codewords for this data block
...
for(o=0;o<y;o++)for(i=0;i<u;i++)C[A++]=I[i][o];return C}(o,e,t))}(t,n,g),v=r.getSymbolSize(t),b=new a(v);return(// Add function modules
/**
 ...
 */function(e,t){let n=e.size,r=-1,o=n-1,i=7,a=0;for(let s=n-1;s>0;s-=2)for(6===s&&s--;;){for(let n=0;n<2;n++)if(!e.isReserved(o,s-n)){let r=!1;a<t.length&&(r=(t[a]>>>i&1)==1),e.set(o,s-n,r),-1==--i&&(a++,i=7)}if((o+=r)<0||n<=o){o-=r,r=-r;break}}}(b,E),isNaN(o)&&(o=u.getBestMask(b,p.bind(null,b,n))),// Apply mask pattern
...
let i=r.getSymbolTotalCodewords(e),l=o.getTotalCodewordsCount(e,t),d=(i-l)*8;if(n===a.MIXED)return d;let c=d-u(n,e);// Return max number of storable codewords
...
return(n<<10|i)^21522}},{eeca831a42e85d6c:"2iHLf"}],kBoY1:[function(e,t,n){let r=e("45f6d4bff9d2fc72"),o=e("73109cbf4f3c309d"),i=e("5320016e34c30467"),a=e("fd16f8f25b581951"),s=e("8a7b84039f1cf0d2"),l=e("79379a3a8f3c26bb"),u=e("66903ca51bd2ea1d"),d=e("3b9f47d541e7d71f");/**
 ...
 * @param  {Number} version QR Code version
 * @return {Array}          Array of segments
 */n.fromString=function(e,t){let o=g(e,u.isKanjiModeEnabled()),i=/**
 ...
 */function(e,t){let n={},o={start:{}},i=["start"];for(let a=0;a<e.length;a++){let s=e[a],l=[];for(let e=0;e<s.length;e++){let u=s[e],d=""+a+e;l.push(d),n[d]={node:u,lastCount:0},o[d]={};for(let e=0;e<i.length;e++){let a=i[e];n[a]&&n[a].node.mode===u.mode?(o[a][d]=h(n[a].lastCount+u.length,u.mode)-h(n[a].lastCount,u.mode),n[a].lastCount+=u.length):(n[a]&&(n[a].lastCount=u.length),o[a][d]=h(u.length,u.mode)+4+r.getCharCountIndicator(u.mode,t)// switch cost
)}}i=l}for(let e=0;e<i.length;e++)o[i[e]].end=0;return{map:o,table:n}}(i,t),s=d.find_path(a.map,"start","end"),l=[];for(let e=1;e<s.length-1;e++)l.push(a.table[s[e]].node);return n.fromArray(l.reduce(function(e,t){let n=e.length-1>=0?e[e.length-1]:null;return n&&n.mode===t.mode?e[e.length-1].data+=t.data:e.push(t),e},[]))},/**
 ...
 * @param  {string} data Input string
 * @return {Array}       Array of segments
 */n.rawSplit=function(e){return n.fromArray(g(e,u.isKanjiModeEnabled()))}},{"45f6d4bff9d2fc72":"2XDDf","73109cbf4f3c309d":"hTs8T","5320016e34c30467":"203uh",fd16f8f25b581951:"f7sIe","8a7b84039f1cf0d2":"1otz8","79379a3a8f3c26bb":"fkiQV","66903ca51bd2ea1d":"2iHLf","3b9f47d541e7d71f":"2Nh6w"}],hTs8T:[function(e,t,n){let r=e("29134b0b0820b091");function o(e){this.mode=r.NUMERIC,this.data=e.toString()}o.getBitsLength=function(e){return 10*Math.floor(e/3)+(e%3?e%3*3+1:0)},o.prototype.getLength=function(){return this.data.length},o.prototype.getBitsLength=function(){return o.getBitsLength(this.data.length)},o.prototype.write=function(e){let t,n;// The input data string is divided into groups of three digits,
...
d=f[a],(void 0===f[a]||d>u)&&(f[a]=u,g.push(a,u),c[a]=i));if(void 0!==n&&void 0===f[n])throw Error(["Could not find a path from ",t," to ",n,"."].join(""));return c},extract_shortest_path_from_predecessor_list:function(e,t){for(var n=[],r=t;r;)n.push(r),e[r],r=e[r];return n.reverse(),n},find_path:function(e,t,n){var o=r.single_source_shortest_paths(e,t,n);return r.extract_shortest_path_from_predecessor_list(o,n)},/**
