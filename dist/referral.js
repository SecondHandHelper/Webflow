...
var c=d(r);// CommonJS
"object"==typeof exports&&"undefined"!=typeof module?module.exports=c:"function"==typeof define&&define.amd?define(function(){return c}):o&&(this[o]=c)}}({"7rA3f":[function(e,t,r){var n=e("@parcel/transformer-js/src/esmodule-helpers.js"),o=e("./general"),i=e("qrcode"),a=n.interopDefault(i);async function s(){let e=new URL(window.location).searchParams;if(!e.has("app")&&!user.current?.referralData?.referralCode)return location.href="/private";let t=user.current?.referralData?.referralCode;if(document.getElementById("referralCode").innerText=t||"",user.current?.referralData?.referredUsers?.length>0&&(document.getElementById("topStatsLoadingIcon").style.display="block"),document.getElementById("referralCode").innerText=user.current.referralData.referralCode,user.current?.referralData?.referredUsers?.length>0){//TOP STATS
...
let e=document.getElementById("infoRequestsList");if(e){let t=e.querySelectorAll('[id^="infoRequest"]:not([style*="display: none"])');if(0===t.length){let e=document.getElementById("infoRequestsDiv");e&&(e.style.display="none")}}}}n.defineInteropFlag(r),n.export(r,"signOut",()=>o),n.export(r,"setFormAddressFields",()=>i),n.export(r,"getFormAddressFields",()=>a),// Validate Swedish Social Security Number (personnummer) using checksum
...
n.export(r,"animateOpenToast",()=>g),n.export(r,"animateCloseToast",()=>h),n.export(r,"hideInfoRequestCard",()=>m)},{"@parcel/transformer-js/src/esmodule-helpers.js":"bNgzC"}],bNgzC:[function(e,t,r){r.interopDefault=function(e){return e&&e.__esModule?e:{default:e}},r.defineInteropFlag=function(e){Object.defineProperty(e,"__esModule",{value:!0})},r.exportAll=function(e,t){return Object.keys(e).forEach(function(r){"default"===r||"__esModule"===r||t.hasOwnProperty(r)||Object.defineProperty(t,r,{enumerable:!0,get:function(){return e[r]}})}),t},r.export=function(e,t,r){Object.defineProperty(e,t,{enumerable:!0,get:r})}},{}],"6s2CO":[function(e,t,r){let n=e("da1f68cc1fc16077"),o=e("8c6cf49ef2287430"),i=e("8a60cf7722cc14ce"),a=e("f6fcc816b915ba37");function s(e,t,r,i,a){let s=[].slice.call(arguments,1),l=s.length,d="function"==typeof s[l-1];if(!d&&!n())throw Error("Callback required as last argument");if(d){if(l<2)throw Error("Too few arguments provided");2===l?(a=r,r=t,t=i=void 0):3===l&&(t.getContext&&void 0===a?(a=i,i=void 0):(a=i,i=r,r=t,t=void 0))}else{if(l<1)throw Error("Too few arguments provided");return 1===l?(r=t,t=i=void 0):2!==l||t.getContext||(i=r,r=t,t=void 0),new Promise(function(n,a){try{let a=o.create(r,i);n(e(a,t,i))}catch(e){a(e)}})}try{let n=o.create(r,i);a(null,e(n,t,i))}catch(e){a(e)}}r.create=o.create,r.toCanvas=s.bind(null,i.render),r.toDataURL=s.bind(null,i.renderToDataURL),// only svg for now.
 ...
 */r.create=function(e,t){let r,g;if(void 0===e||""===e)throw Error("No input text");let y=o.M;return void 0!==t&&(// Use higher error correction level as default
y=o.from(t.errorCorrectionLevel,o.M),r=f.from(t.version),g=d.from(t.maskPattern),t.toSJISFunc&&n.setToSJISFunction(t.toSJISFunc)),/**
...
let a=n.getSymbolTotalCodewords(t),s=u.getTotalCodewordsCount(t,r),l=a-s,d=u.getBlocksCount(t,r),f=a%d,g=d-f,h=Math.floor(a/d),m=Math.floor(l/d),p=m+1,y=h-m,v=new c(y),E=0,b=Array(d),I=Array(d),B=0,C=new Uint8Array(e.buffer);// Divide the buffer into the required number of blocks
...
for(o=0;o<y;o++)for(i=0;i<d;i++)w[A++]=I[i][o];return w}(o,e,t))}(t,r,g),E=n.getSymbolSize(t),b=new a(E);return(// Add function modules
/**
 ...
 */function h(e,t){switch(t){case n.NUMERIC:return o.getBitsLength(e);case n.ALPHANUMERIC:return i.getBitsLength(e);case n.KANJI:return s.getBitsLength(e);case n.BYTE:return a.getBitsLength(e)}}/**
 ...
 * @param  {Number} version QR Code version
 * @return {Array}          Array of segments
 */r.fromString=function(e,t){let o=g(e,d.isKanjiModeEnabled()),i=/**
 ...
 */function(e,t){let r={},o={start:{}},i=["start"];for(let a=0;a<e.length;a++){let s=e[a],l=[];for(let e=0;e<s.length;e++){let d=s[e],u=""+a+e;l.push(u),r[u]={node:d,lastCount:0},o[u]={};for(let e=0;e<i.length;e++){let a=i[e];r[a]&&r[a].node.mode===d.mode?(o[a][u]=h(r[a].lastCount+d.length,d.mode)-h(r[a].lastCount,d.mode),r[a].lastCount+=d.length):(r[a]&&(r[a].lastCount=d.length),o[a][u]=h(d.length,d.mode)+4+n.getCharCountIndicator(d.mode,t)// switch cost
 ...
 * @param  {string} data Input string
 * @return {Array}       Array of segments
 */r.rawSplit=function(e){return r.fromArray(g(e,d.isKanjiModeEnabled()))}},{"45f6d4bff9d2fc72":"2XDDf","73109cbf4f3c309d":"hTs8T","5320016e34c30467":"203uh",fd16f8f25b581951:"f7sIe","8a7b84039f1cf0d2":"1otz8","79379a3a8f3c26bb":"fkiQV","66903ca51bd2ea1d":"2iHLf","3b9f47d541e7d71f":"2Nh6w"}],hTs8T:[function(e,t,r){let n=e("29134b0b0820b091");function o(e){this.mode=n.NUMERIC,this.data=e.toString()}o.getBitsLength=function(e){return 10*Math.floor(e/3)+(e%3?e%3*3+1:0)},o.prototype.getLength=function(){return this.data.length},o.prototype.getBitsLength=function(){return o.getBitsLength(this.data.length)},o.prototype.write=function(e){let t,r;// The input data string is divided into groups of three digits,
...
var g=n.PriorityQueue.make();for(g.push(t,0);!g.empty();)// ...and explore the edges that connect u to those nodes, updating
...
u=f[a],(void 0===f[a]||u>d)&&(f[a]=d,g.push(a,d),c[a]=i));if(void 0!==r&&void 0===f[r])throw Error(["Could not find a path from ",t," to ",r,"."].join(""));return c},extract_shortest_path_from_predecessor_list:function(e,t){for(var r=[],n=t;n;)r.push(n),e[n],n=e[n];return r.reverse(),r},find_path:function(e,t,r){var o=n.single_source_shortest_paths(e,t,r);return n.extract_shortest_path_from_predecessor_list(o,r)},/**
