...
let a=n.getSymbolTotalCodewords(t),s=d.getTotalCodewordsCount(t,r),l=a-s,u=d.getBlocksCount(t,r),f=a%u,g=u-f,h=Math.floor(a/u),m=Math.floor(l/u),p=m+1,y=h-m,E=new c(y),b=0,v=Array(u),I=Array(u),B=0,C=new Uint8Array(e.buffer);// Divide the buffer into the required number of blocks
