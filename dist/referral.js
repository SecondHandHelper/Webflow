...
let a=n.getSymbolTotalCodewords(t),s=d.getTotalCodewordsCount(t,r),l=a-s,u=d.getBlocksCount(t,r),f=a%u,h=u-f,g=Math.floor(a/u),m=Math.floor(l/u),p=m+1,y=g-m,v=new c(y),E=0,b=Array(u),I=Array(u),B=0,w=new Uint8Array(e.buffer);// Divide the buffer into the required number of blocks
...
for(o=0;o<y;o++)for(i=0;i<u;i++)C[A++]=I[i][o];return C}(o,e,t))}(t,r,h),E=n.getSymbolSize(t),b=new a(E);return(// Add function modules
/**
