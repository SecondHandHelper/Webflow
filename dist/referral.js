...
})({"a867E":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 50619;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "8a5894f2fea453c3";
"use strict";
...
},{}],"evH6t":[function(require,module,exports) {
...
async function main() {
    ...
    if (user.current?.referralData?.referredUsers?.length > 0) {
        ...
        const referredUserStatsResponse = await (0, _general.callBackendApi)("/api/users/referredUserStats", {
            requiresAuth: true
        });
        ...
        (0, _general.callBackendApi)("/api/users/referralStats", {
            requiresAuth: true
        }).then((referralStatsResponse)=>{
...
shareReferralLinkButton.addEventListener("click", (0, _general.shareCode));
...
if (sessionUser?.referralData?.referredUsers?.length > 0) document.getElementById("topStatsLoadingIcon").style.display = "block";
var isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
if (isMobile) {
    user.whenSet(main);
    if (!sessionUser) location.href = "/sign-in";
} else {
...
},{"./general":"lWrRo","qrcode":"lB7MY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lWrRo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"c36bbcf663291acc":"6rMWz"}]},["a867E","evH6t"], "evH6t", "parcelRequire81ca")
