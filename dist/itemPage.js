...
async function loadItem(itemId) {
    ...
    if (data.status === "Sold") {
        ...
        // Happy case
        if (trustedSellerEnabled && notTrustedSeller) text1 = "Du f\xe5r betalt 5 dagar efter att k\xf6paren h\xe4mtat ut plagget, och ingen reklamation har skett.";
        else text1 = data.payoutStatus === "Payed" ? "" : data.payoutType === 'Brand Gift Card' ? "Presentkortet skapas inom en dag" : "Utbetalning kommer via Swish inom en dag";
