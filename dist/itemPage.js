...
async function loadItem(itemId) {
    ...
    if (data.status === "Sold") {
        ...
        // Happy case
        if (trustedSellerEnabled && notTrustedSeller) text1 = "Utbetalning sker 5 dagar efter att k\xf6paren mottagit plagget och ingen skickavvikelse rapporteras.";
        ...
        if (data.shippingStatus === "Not sent") {
        ...
        } else if (trustedSellerEnabled && notTrustedSeller) {
            ...
            // Return case
                ...
                if (item.returnShippingStatus === "Collected") {
                    ...
                    text1 = "Plaggets skick avvek fr\xe5n beskrivningen, det \xe4r nu p\xe5 v\xe4g tillbaka till dig.";
