...
let t="Vestiaire Collective"===C&&s>7;var D="",P="";let n="",o="",a="",l=`Du f\xe5r ${h} kr`,m="",g="";if(t)D=function(e){let t=window.location.origin+`/sell-item?id=${e}`,n=`<a id="resellButton" href="${t}" class="link-block-39">
...
let e="",t=n.split(" ");t.forEach(function(t){e.trim().length>n.length/2&&!e.includes("<br>")&&(e+="<br>"),e+=t+" "}),m=e.trim()}m="Brand Gift Card"===e.payoutType?`(${brandPartners[e.brand].name}-presentkort)<br>`+m:m,g=t&&"Brand Gift Card"!==e.payoutType?`\xc4ndra till ${p} kr i presentkort?`:""}"Service point"===w&&(T?(D=function(e){let t=window.location.origin+`/ship-item?id=${e}`,n=`<a id="barcodeButton" href="${t}" class="link-block-39">
                    ...
                    </a>`;return n}(c),a="dhl"):"Vestiaire Collective"===C||"Grailed"===C?L||(D=d(c,u,w),S&&(a="ups"),// Store event listener data for batch processing
window._pendingEventListeners=window._pendingEventListeners||[],window._pendingEventListeners.push({type:"bagReceivedCheckbox",itemId:c,soldDate:u,shippingMethod:w})):E&&(a="postnord",D=function(e){let t=window.location.origin+`/ship-item?id=${e}`,n=`<a id="qrCodeButton" href="${t}" class="link-block-39">
                            <div class="div-block-194">
                    ...
                    </a>`;return n}(c))),"Pickup"===w&&(L?L&&!B&&(D=function(e){let t=`<a id="bookPickupButton-${e}" href="#" class="link-block-39">
                            <div class="div-block-194">
                                <div class="text-block-113">Boka h\xe4mtning</div>
                            </div>
                    </a>`;return t}(c),// Store event listener data for batch processing
window._pendingEventListeners=window._pendingEventListeners||[],window._pendingEventListeners.push({type:"bookPickupButton",itemId:c,soldDate:u})):(D=d(c,u,w),// Store event listener data for batch processing
...
let t=document.getElementById("blurryOverlay");t&&(t.style.display="block");let n=document.getElementById("onlyMobileBox");n&&(n.style.display="block")}},{"./general":"1tOWF","./infoRequestsFunctions":"21npA","./loadItemCards":"dxOtH",qrcode:"6s2CO","@parcel/transformer-js/src/esmodule-helpers.js":"bNgzC"}],"21npA":[function(e,t,n){let r,i,o,a;var l=e("@parcel/transformer-js/src/esmodule-helpers.js");l.defineInteropFlag(n),l.export(n,"loadInfoRequests",()=>p);var s=e("./general");/**
