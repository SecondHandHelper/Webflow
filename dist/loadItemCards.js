...
setTimeout(()=>{t.style.transform="translateY(0%)"},10),document.getElementById("darkOverlay").classList.add("active"))}function y(e){let t=document.getElementById(e);// Add the visibility check here
...
setTimeout(()=>{t.style.display="none"},300),document.getElementById("darkOverlay").classList.remove("active"))}function h(e){let t=document.getElementById(e);if(t){t.style.display="none";// Check if there are any remaining visible cards
...
i.export(n,"closeMenuWithAnimation",()=>g),i.export(n,"setupMenuHandlers",()=>f),// Toast animation functions
i.export(n,"animateOpenToast",()=>p),i.export(n,"animateCloseToast",()=>y),i.export(n,"hideInfoRequestCard",()=>h)},{"@parcel/transformer-js/src/esmodule-helpers.js":"bNgzC"}],bNgzC:[function(e,t,n){n.interopDefault=function(e){return e&&e.__esModule?e:{default:e}},n.defineInteropFlag=function(e){Object.defineProperty(e,"__esModule",{value:!0})},n.exportAll=function(e,t){return Object.keys(e).forEach(function(n){"default"===n||"__esModule"===n||t.hasOwnProperty(n)||Object.defineProperty(t,n,{enumerable:!0,get:function(){return e[n]}})}),t},n.export=function(e,t,n){Object.defineProperty(e,t,{enumerable:!0,get:n})}},{}],flS2m:[function(e,t,n){var i,r=e("@parcel/transformer-js/src/esmodule-helpers.js");r.defineInteropFlag(n),// async function initAppDownloadBanner() {
...
let d=user.current?.trustedSellerStatus==="Trusted";user.current?.trustedSellerStatus,o&&!r&&!["l3FdLmp4CHU0tdmGXvVkjx1inr32"].includes(e)&&(d||a)&&(location.href="/personal-id-form")}async function p(){var e;if(console.log("privateMain running"),!user.current)return;c(i=authUser.current.uid,authUser.current.email||sessionStorage.getItem("email"),authUser.current.phoneNumber||sessionStorage.getItem("phoneNumber")),f(i),user.current?.trustedSellerStatus==="Trusted"?document.getElementById("trustedIconHeader").style.display="block":(document.getElementById("fullLogo").style.display="block",document.getElementById("onlyLogo").style.display="none"),user.current?.maiCircle&&(document.getElementById("headerMaiCircleButton").style.display="flex",document.getElementById("cta-header-text").style.display="none",document.getElementById("cta-header").style.borderRadius="9999px"),(e=document.getElementById("itemListSoldByOthers")).innerHTML="",// SOLD BY OTHERS QUERY + Add cards to list
