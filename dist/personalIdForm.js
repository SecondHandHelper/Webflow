...
})({"dDWs0":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "1f71304be96c8ae9";
"use strict";
...
},{}],"dTwNH":[function(require,module,exports,__globalThis) {
var _general = require("./general");
async function addPersonalId() {
    // Grab values from form
    let personalId = document.getElementById("personalId").value;
    personalId = (0, _general.formatPersonalId)(personalId);
    // Write to Firestore
    if (personalId) {
...
document.getElementById('personalId').addEventListener("input", ()=>{
    const error = (0, _general.isValidSwedishSsn)(document.getElementById('personalId').value) ? '' : 'Ogiltigt personnummer';
...
},{}]},["dDWs0","dTwNH"], "dTwNH", "parcelRequire81ca")
