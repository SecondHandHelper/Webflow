...
})({"jqdPm":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "6e37826bf6e12208";
"use strict";
...
},{}],"aXebp":[function(require,module,exports,__globalThis) {
    ...
    document.getElementById('runButton').addEventListener('click', async function() {
        ...
        if (data) {
            ...
            const formatValue = (value)=>{
                if (typeof value === 'object' && value !== null) return Object.entries(value).map(([k, v])=>`<br>- ${k}: ${v}`).join('');
                return value;
            };
            const formattedResult = Object.entries(data).map(([key, value])=>`<p><strong>${key}:</strong> ${formatValue(value)}</p>`).join('');
...
},{}]},["jqdPm","aXebp"], "aXebp", "parcelRequire81ca", {})
