...
const getValuationExplanation = (item)=>{
    const { mlValuation: { valuatedBrandItems, brandMeanMax, brandAccuracy, brandCategoryAccuracy, fewBrand, brandMeanSold, brandCategoryMeanSold, newMinMaxLog, brandShareSold }, cleanedBrand, brand } = item;
    const brandName = cleanedBrand || brand;
    const bestMeanPrice = brandAccuracy > 0.8 && brandMeanSold > 0 ? `Snittpriset f\xf6r s\xe5lda plagg f\xf6r varum\xe4rket \xe4r ${brandMeanSold} kr.` : brandCategoryAccuracy > 0.7 && brandCategoryMeanSold > 0 ? `Snittpriset f\xf6r s\xe5lda plagg f\xf6r varum\xe4rket i denna kategori \xe4r ${brandCategoryMeanSold} kr.` : "";
    ...
    const adjustPriceLowShareSoldNotice = brandShareSold < 0.5 ? `Notera att efterfr\xe5gan p\xe5 ${brandName} p\xe5 andrahandsmarknaden \xe4r l\xe4gre \xe4n snittet, s\xe5 vill du \xf6ka sannolikheten att f\xe5 det s\xe5lt kan du s\xe4nka det l\xe4gsta priset.` : "";
    const adjustPriceNotice = "Om du mot f\xf6rmodan \xe4nd\xe5 vill justera kan du g\xf6ra det, men t\xe4nk p\xe5 att det p\xe5verkar sannolikheten att f\xe5 det s\xe5lt.";
    ...
    if (brandAccuracy >= 0.8 && !fewBrand) return `${acceptPriceNotice}AI-v\xe4rderingen baseras p\xe5 ${valuatedBrandItems} plagg fr\xe5n ${brandName} som vi tidigare v\xe4rderat, och vi brukar ha h\xf6g tr\xe4ffs\xe4kerhet p\xe5 detta varum\xe4rke. ${adjustPriceLowShareSoldNotice || adjustPriceNotice} ${bestMeanPrice}`;
    if (brandAccuracy < 0.8 && brandCategoryAccuracy >= 0.7 && !fewBrand) return `${acceptPriceNotice}AI-v\xe4rderingen baseras p\xe5 ${valuatedBrandItems} plagg fr\xe5n ${brandName} som vi tidigare v\xe4rderat, och f\xf6r just denna kategori fr\xe5n varum\xe4rket brukar vi ha h\xf6g tr\xe4ffs\xe4kerhet. ${adjustPriceLowShareSoldNotice || adjustPriceNotice} ${bestMeanPrice}`;
