...
})({"2ZCQn":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "b938e1fbfad81e90";
"use strict";
...
},{}],"dRrEG":[function(require,module,exports,__globalThis) {
...
function handleResetPassword(auth1, actionCode, continueUrl, lang) {
...
function handleRecoverEmail(auth1, actionCode, lang) {
    // Localize the UI to the selected language as determined by the lang
    // parameter.
...
function handleVerifyEmail(auth1, actionCode, continueUrl, lang) {
    // Localize the UI to the selected language as determined by the lang
    // parameter.
...
function sendEmailVerification(auth1) {
    authUser.whenSet((user)=>{
        if (user) emailVerificationText.innerHTML = `Klicka p\xe5 l\xe4nken i mailet vi skickat till ${user.email} f\xf6r att verifiera din email.`;
...
savePasswordAndLoginButton.addEventListener('click', function() {
    ...
    auth.confirmPasswordReset(actionCode, password).then((resp)=>{
        ...
        // Sign in
        firebase.auth().signInWithEmailAndPassword(accountEmail, password).then((userCredential)=>{
...
},{}]},["2ZCQn","dRrEG"], "dRrEG", "parcelRequire81ca", {})
