...
var u=d(t);// CommonJS
"object"==typeof exports&&"undefined"!=typeof module?module.exports=u:"function"==typeof define&&define.amd?define(function(){return u}):i&&(this[i]=u)}}({"6Z4Mv":[function(e,n,t){var o;function i(e){let n=getParamsObject();return n[e]}// Get the action to complete
let r=i("mode"),a=i("oobCode");// Handle the user management action.
switch(i("continueUrl"),i("lang"),r){case"resetPassword":// Display reset password handler and UI.
...
// the new password.
accountEmailText.innerHTML=`Email: ${o}`,resetPasswordDiv.style.display="block",loadingDiv.style.display="none"}).catch(e=>{errorHandler.report(e),console.log(e.code,e.message)})}(auth,a,0,0);break;case"recoverEmail":// Display email recovery handler and UI.
...
})}(auth,a,0);break;case"verifyEmail":// Display email verification handler and UI.
...
// again.
})}(auth,a,0,0);break;case"sendEmailVerification":// Display email verification handler and UI.
...
passwordLoadIcon.style.display="block",savePasswordAndLoginButton.style.display="none";var e=newPassword.value;auth.confirmPasswordReset(a,e).then(n=>{console.log("Password reset has been confirmed and new password updated"),// Sign in
