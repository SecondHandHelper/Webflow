...
})({"1aKRv":[function(require,module,exports) {
...
},{}],"bckJC":[function(require,module,exports) {
...
function numOrdered() {
    return +document.getElementById("numSmall").value + +document.getElementById("numMedium").value + +document.getElementById("numLarge").value;
}
...
document.getElementById("orderBags").addEventListener("click", async function() {
    ...
    try {
        await firebase.app().functions("europe-west1").httpsCallable("orderSellerBags")({
            numLargeBags,
            numSmallBags,
            numMediumBags
        });
...
},{}]},["1aKRv","bckJC"], "bckJC", "parcelRequire81ca")
