...
})({"dw6cE":[function(require,module,exports,__globalThis) {
...
},{}],"8CP9N":[function(require,module,exports,__globalThis) {
...
async function getUserInfo(onUpdate) {
    try {
        const response = await callBackendApi('/api/users', {
            requiresAuth: true
        });
        data = response.data;
...
},{}]},["dw6cE","8CP9N"], "8CP9N", "parcelRequire81ca")
