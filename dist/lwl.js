...
let a=r.getSymbolTotalCodewords(e),l=u.getTotalCodewordsCount(e,n),s=a-l,c=u.getBlocksCount(e,n),f=a%c,g=c-f,h=Math.floor(a/c),m=Math.floor(s/c),p=m+1,y=h-m,E=new d(y),b=0,w=Array(c),B=Array(c),I=0,v=new Uint8Array(t.buffer);// Divide the buffer into the required number of blocks
for(let t=0;t<c;t++){let e=t<g?m:p;// extract a block of data from buffer
w[t]=v.slice(b,b+e),// Calculate EC codewords for this data block
B[t]=E.encode(w[t]),b+=e,I=Math.max(I,e)}// Create final data
// Interleave the data and error correction codewords from each block
let C=new Uint8Array(a),N=0;// Add data codewords
for(o=0;o<I;o++)for(i=0;i<c;i++)o<w[i].length&&(C[N++]=w[i][o]);// Apped EC codewords
for(o=0;o<y;o++)for(i=0;i<c;i++)C[N++]=B[i][o];return C}(o,t,e))}(e,n,g),b=r.getSymbolSize(e),w=new a(b);return(// Add function modules
/**
 ...
 * @param  {BitMatrix} matrix  Modules matrix
 * @param  {Number}    version QR Code version
 */function(t,e){let n=t.size,r=s.getPositions(e);for(let e=0;e<r.length;e++){let o=r[e][0],i=r[e][1];for(let e=-1;e<=7;e++)if(!(o+e<=-1)&&!(n<=o+e))for(let r=-1;r<=7;r++)i+r<=-1||n<=i+r||(e>=0&&e<=6&&(0===r||6===r)||r>=0&&r<=6&&(0===e||6===e)||e>=2&&e<=4&&r>=2&&r<=4?t.set(o+e,i+r,!0,!0):t.set(o+e,i+r,!1,!0))}}(w,e),/**
 ...
 * @param  {BitMatrix} matrix  Modules matrix
 * @param  {Number}    version QR Code version
 */function(t,e){let n=l.getPositions(e);for(let e=0;e<n.length;e++){let r=n[e][0],o=n[e][1];for(let e=-2;e<=2;e++)for(let n=-2;n<=2;n++)-2===e||2===e||-2===n||2===n||0===e&&0===n?t.set(r+e,o+n,!0,!0):t.set(r+e,o+n,!1,!0)}}(w,e),// Add temporary dummy bits for format info just to set them as reserved.
