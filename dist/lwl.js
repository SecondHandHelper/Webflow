...
let a=r.getSymbolTotalCodewords(e),l=u.getTotalCodewordsCount(e,n),s=a-l,c=u.getBlocksCount(e,n),f=a%c,g=c-f,h=Math.floor(a/c),m=Math.floor(s/c),p=m+1,y=h-m,E=new d(y),w=0,b=Array(c),B=Array(c),I=0,v=new Uint8Array(t.buffer);// Divide the buffer into the required number of blocks
...
B[t]=E.encode(b[t]),w+=e,I=Math.max(I,e)}// Create final data
// Interleave the data and error correction codewords from each block
let C=new Uint8Array(a),N=0;// Add data codewords
for(o=0;o<I;o++)for(i=0;i<c;i++)o<b[i].length&&(C[N++]=b[i][o]);// Apped EC codewords
for(o=0;o<y;o++)for(i=0;i<c;i++)C[N++]=B[i][o];return C}(o,t,e))}(e,n,g),w=r.getSymbolSize(e),b=new a(w);return(// Add function modules
/**
