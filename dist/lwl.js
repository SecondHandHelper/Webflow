...
})({"585FE":[function(require,module,exports) {
...
if (params.createDrafts === "true") {
    if (localStorage.getItem("lwlItemDrafts") && (document.referrer.includes("sign-in") || document.referrer.includes("private"))) {
        ...
        authUser.whenSet(async ()=>{
            await Promise.all(draftItems.map((item)=>callBackendApi(`/api/items/${item.id}`, {
                    data: {
                        item
                    }
                })));
...
},{"qrcode":"lB7MY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lB7MY":[function(require,module,exports) {
...
},{"c36bbcf663291acc":"6rMWz"}],"gkKU3":[function(require,module,exports) {
...
},{}]},["585FE","8V3ht"], "8V3ht", "parcelRequire81ca")
