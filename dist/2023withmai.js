...
})({"c2f5I":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "43d7f74bd685d5ba";
"use strict";
...
},{}],"fvFwd":[function(require,module,exports,__globalThis) {
async function main() {
    ...
    if (yearlyData.sold) {
        ...
        if (yearlyData.name) document.getElementById('letterTitle').innerHTML = yearlyData.name.charAt(0).toUpperCase() + yearlyData.name.slice(1) + ',';
...
},{}]},["c2f5I","fvFwd"], "fvFwd", "parcelRequire81ca")
