...
$("#frontImage").off("change"),e.addEventListener("change",K,{capture:!0}),$("#brandTagImage").off("change"),t.addEventListener("change",U,{capture:!0}),$("#productImage").off("change"),n.addEventListener("change",q,{capture:!0}),$("#defectImage").off("change"),o.addEventListener("change",z,{capture:!0}),$("#materialTag").off("change"),i.addEventListener("change",J,{capture:!0}),$("#extraImage").off("change"),f.addEventListener("change",G,{capture:!0}),(0,c.setupModelSearchEventListeners)(),function(){let e=document.getElementById("itemColor");e.onchange=function(){""!==this.value?e.style.color="#333":e.style.color="#929292"};// Change font color of dropdown itemAge when user selects a value
