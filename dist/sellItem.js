...
let i=a.getSymbolTotalCodewords(t),l=c.getTotalCodewordsCount(t,n),s=i-l,d=c.getBlocksCount(t,n),m=i%d,g=d-m,f=Math.floor(i/d),p=Math.floor(s/d),h=p+1,y=f-p,I=new u(y),S=0,v=Array(d),b=Array(d),B=0,x=new Uint8Array(e.buffer);// Divide the buffer into the required number of blocks
...
for(o=0;o<y;o++)for(r=0;r<d;r++)E[k++]=b[r][o];return E}(o,e,t))}(t,n,g),S=a.getSymbolSize(t),v=new i(S);return(// Add function modules
/**
