...
async function setCampaignCoupon() {
    ...
    if (campaignDateOk && getCookie("noCommissionCampaignCookie") === "noCommission" && await userItemsCount() === 1) await firebase.app().functions("europe-west1").httpsCallable("setNoCommissionCoupon")();
}
