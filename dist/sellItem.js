...
})({"ehQqV":[function(require,module,exports) {
...
},{}],"edX6B":[function(require,module,exports) {
...
async function sellItemMainAuthenticated() {
    ...
    if (sessionStorage.getItem("itemToBeCreatedAfterSignIn")) {
        ...
        if (document.referrer.includes("/sign-in")) {
            ...
            if (shippingMethod) await (0, _general.callBackendApi)("/api/users", {
                data: {
                    preferences: {
                        shippingMethod
                    }
...
async function sellItemMain() {
    ...
    itemCondition.addEventListener("input", ()=>{
        if (itemCondition.value === "Anv\xe4nd, men utan anm\xe4rkning") {
            if (authUser.current) {
                ...
                } else db.collection("users").doc(authUser.current.uid).update({
                    elementViews: firebase.firestore.FieldValue.arrayUnion({
                        elementID: "conditionUsedInfoBox",
                        timestamp: new Date()
                    })
                });
            } else if (getCookie("conditionUsedInfoBoxSeen") !== "true") {
                document.getElementById("triggerOpenConditionUsedInfo").click();
                setCookie("conditionUsedInfoBoxSeen", "true", 100);
            }
        }
    ...
    usedNoDefect.addEventListener("click", ()=>{
        selectFieldValue(itemCondition, "Anv\xe4nd, men utan anm\xe4rkning");
    });
    usedDefect.addEventListener("click", ()=>{
        selectFieldValue(itemCondition, "Anv\xe4nd, tecken p\xe5 slitage");
    });
...
async function saveValuationInStorageOrBackend(valuationData, itemId) {
    if (sessionStorage.getItem("itemToBeCreatedAfterSignIn")) {
        ...
        await (0, _general.callBackendApi)(`/api/valuation/${itemId}`, {
            data: valuationData,
            requiresAuth: false
        });
...
async function saveItemValuation(itemId, mlValuationData) {
    const { minPrice, maxPrice, decline, humanCheckNeeded, humanCheckExplanation, willNotSell, soldPrice, version, newMinPriceEstimate, newMaxPriceEstimate, newMinMaxLog, adjustmentAllowed, newBrand, newBrandCategory, valuatedBrandItems, brandMeanMax, brandAccuracy, brandCategoryAccuracy, fewBrand, brandMeanSold, brandCategoryMeanSold, highPriceVarBrandCategory, brandShareSold } = mlValuationData || {};
    ...
    const valuationData = {
        mlValuation: {
            ...
            brandMeanMax,
            brandAccuracy,
            brandCategoryAccuracy,
            fewBrand,
            brandMeanSold,
            brandCategoryMeanSold,
            highPriceVarBrandCategory,
            brandShareSold
        },
...
async function getAndSaveValuation(itemId, item) {
    ...
    if (params.id && params.type !== "draft") {
        const getItemResponse = await (0, _general.callBackendApi)(`/api/items/${params.id}`);
        const resellItem = getItemResponse.data;
        await setValuationFromResellItem(resellItem, item, itemId);
        return "/item-valuation";
    }
    try {
        const res = await (0, _general.callBackendApi)("/api/valuation", {
            data: {
                itemId,
                item
            },
...
async function getShippingMethod() {
    ...
    if (!user.current?.preferences?.shippingMethod) {
        if (authUser.current) await (0, _general.callBackendApi)("/api/users", {
            data: {
                preferences: {
                    shippingMethod
                }
...
async function addItemInner(id, status1 = "New") {
    ...
    if (modelCoverImageUrl) images["modelImage"] = modelCoverImageUrl;
    ...
    if (!authUser.current) sessionStorage.setItem("itemToBeCreatedAfterSignIn", JSON.stringify({
        ...
        const createItemResponse = await (0, _general.callBackendApi)(`/api/items/${id}`, {
            data: {
                item
            }
        });
...
async function setCampaignCoupon() {
    ...
    if (campaignDateOk && getCookie("noCommissionCampaignCookie") === "noCommission" && await userItemsCount() === 1) await (0, _general.callBackendApi)("/api/users/noCommissionCoupon", {
        method: "PUT"
    });
}
async function createItemAfterSignIn() {
    ...
    sessionStorage.removeItem("itemToBeCreatedAfterSignIn");
    sessionStorage.removeItem("newItemId");
    await (0, _general.callBackendApi)(`/api/items/${itemFromStorage.id}`, {
...
function rememberUnsavedChanges() {
    ...
    const { user: user1, createdAt, status: status1, shippingStatus, modelVariantFields, ...itemToSave } = collect();
    ...
    try {
        ...
        if (!savedItem) {
            [item, atItemResponse] = await Promise.all([
                (0, _general.callBackendApi)(`/api/items/${itemId}`),
                (0, _general.callBackendApi)(`/api/items/${itemId}/atItem`)
            ]);
            itemDraft = item;
        }
        ...
        data.brand && (0, _sellItemModelSearch.displayFindModelDiv)(data.brand).then(()=>{
            if (sessionStorage.getItem("models") && data.atModelVariantId) {
                ...
                if (model) (0, _sellItemModelSearch.showSelectedModel)(JSON.stringify(model));
            }
        });
...
async function checkAndDisplayShareSold(value) {
    const response = await (0, _general.callBackendApi)(`/api/brands/shareSold?brand=${value}`);
...
async function frontImageChangeHandler(event) {
    ...
    if (input) {
        ...
        const promises = [];
        promises.push(detectAndFillColor(imageUrl), detectAndFillBrandAndMaterialAndSize(imageUrl), (0, _sellItemHelpers.enhanceFrontImage)(imageUrl));
...
async function detectAndFillColor(imageUrl) {
    ...
    try {
        ...
        else if (apiColorMapping[response.data.colors?.[0]]) document.querySelector("#itemColor").value = apiColorMapping[response.data.colors?.[0]];
        else {
...
},{"./sellItemHelpers":"8xEoj","qrcode":"lB7MY","./general":"lWrRo","./autocomplete-brands":"aDjZV","./sellItemModelSearch":"a9ry4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8xEoj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"lB7MY":[function(require,module,exports) {
...
},{"c36bbcf663291acc":"6rMWz"}],"aDjZV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"a9ry4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const showSelectedModel = (modelJson)=>{
...
const showModelSizes = (modelClicked)=>{
    ...
    if (model.sizes.length === 1) return selectSize(modelClicked)({
        target: {
...
const setupModelSearchEventListeners = ()=>{
    ...
    document.getElementById("modelSearchInput").addEventListener("input", ()=>{
        ...
        } else showModelItems(modelDb.sort(modelCompare));
    });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ehQqV","edX6B"], "edX6B", "parcelRequire81ca")
