...
let h=document.getElementById("itemBrand"),I=document.getElementById("itemCategory");if(h.oninput=function(){shareSoldDiv.style.display="none",(0,r.checkBlockedOrLowShareSoldBrand)(this.value,I.value)},// Hide/Show extra fields for defects
