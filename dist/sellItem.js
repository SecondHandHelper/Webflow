...
let y=document.getElementById("itemBrand"),I=document.getElementById("itemCategory");if(y.oninput=function(){shareSoldDiv.style.display="none",(0,i.checkBlockedOrLowShareSoldBrand)(this.value,I.value)},// Hide/Show extra fields for defects
 ...
 */function h(e,t,n){let a,r;let o=e.size,i=g.getEncodedBits(t,n);for(a=0;a<15;a++)r=(i>>a&1)==1,a<6?e.set(a,8,r,!0):a<8?e.set(a+1,8,r,!0):e.set(o-15+a,8,r,!0),a<8?e.set(8,o-a-1,r,!0):a<9?e.set(8,15-a-1+1,r,!0):e.set(8,15-a-1,r,!0);// fixed module
e.set(o-8,8,1,!0)}/**
 * QR Code
 *
...
let i=a.getSymbolTotalCodewords(t),l=c.getTotalCodewordsCount(t,n),s=i-l,d=c.getBlocksCount(t,n),m=i%d,g=d-m,f=Math.floor(i/d),p=Math.floor(s/d),h=p+1,y=f-p,I=new u(y),S=0,b=Array(d),v=Array(d),B=0,x=new Uint8Array(e.buffer);// Divide the buffer into the required number of blocks
for(let e=0;e<d;e++){let t=e<g?p:h;// extract a block of data from buffer
