...
let i=a.getSymbolTotalCodewords(t),l=c.getTotalCodewordsCount(t,n),s=i-l,d=c.getBlocksCount(t,n),m=i%d,g=d-m,f=Math.floor(i/d),h=Math.floor(s/d),p=h+1,y=f-h,I=new u(y),S=0,B=Array(d),v=Array(d),E=0,b=new Uint8Array(e.buffer);// Divide the buffer into the required number of blocks
for(let e=0;e<d;e++){let t=e<g?h:p;// extract a block of data from buffer
B[e]=b.slice(S,S+t),// Calculate EC codewords for this data block
v[e]=I.encode(B[e]),S+=t,E=Math.max(E,t)}// Create final data
// Interleave the data and error correction codewords from each block
let x=new Uint8Array(i),C=0;// Add data codewords
for(r=0;r<E;r++)for(o=0;o<d;o++)r<B[o].length&&(x[C++]=B[o][r]);// Apped EC codewords
