...
var u=d(n);// CommonJS
"object"==typeof exports&&"undefined"!=typeof module?module.exports=u:"function"==typeof define&&define.amd?define(function(){return u}):r&&(this[r]=u)}}({"42EGR":[function(e,t,n){let a;var r,o=e("@parcel/transformer-js/src/esmodule-helpers.js");o.defineInteropFlag(n),o.export(n,"isNoBgImage",()=>X);var i=e("./sellItemHelpers"),l=e("qrcode"),s=o.interopDefault(l),d=e("./general"),c=e("./autocomplete-brands"),u=e("./sellItemModelSearch");let m=!1,g=getParamsObject();async function f(){// Grab values from form
let e=(0,d.getFormAddressFields)(),t=document.getElementById("personalId").value;t=t?(0,d.formatPersonalId)(t):null;// Write to Firestore
let n=db.collection("users").doc(authUser.current.uid);n.update({...e,personalId:t}).then(()=>{console.log(`User address of ${authUser.current.uid} is now updated`),itemConfirmationScreen.style.display="block",addressFormDiv.style.display="none"}).catch(e=>{errorHandler.report(e),console.error("Error updating document: ",e)})}function p(){return new Map().set("hole","H\xe5l").set("stain","Fl\xe4ck").set("lostFit","Tappad passform").set("nopprig","Nopprig").set("threadUp","Tr\xe5dsl\xe4pp").set("colorChange","F\xe4rg\xe4ndring").set("otherDefect","Annat")}function y(){return["frontImage","brandTagImage","defectImage","materialTagImage","extraImage"]}async function h(){// Create item from sessionStorage
if(console.log("sellItemMainAuthenticated "+new Date),"draft"!==g.type&&"resell"!==g.type&&(document.getElementById("saveItemDraftButton").style.display="flex"),window.addEventListener("beforeunload",()=>{(g.id||m)&&localStorage.removeItem("newItem")}),// Visa alla "viktiga" fält om man är inloggad
...
if(document.referrer.includes("/sign-in")){document.getElementById("loadingDiv").style.display="flex",document.getElementById("creatingItemText").style.display="block",await L();let e=sessionStorage.getItem("shippingMethod");e&&await firebase.app().functions("europe-west1").httpsCallable("updateFirebaseUser")({preferences:{shippingMethod:e}});let t=user.current?.phoneNumber?.length;return location.href=t?"/item-confirmation":"/user-contact"}sessionStorage.removeItem("itemToBeCreatedAfterSignIn")}// Get user's item count to be able to send 'User Activated' event
let e=await getItems(authUser.current.uid);r=e.docs.filter(e=>e.data()?.status!=="Draft").length}async function I(){let e,t,n,r,o,l;let p=document.getElementById("qrCanvas");p&&(0,s.default).toCanvas(p,window.location.href,function(e){e&&console.error(e),console.log("success!")}),localStorage.removeItem("latestItemCreated"),sessionStorage.removeItem("itemValuation"),e=document.getElementById("frontImage"),t=document.getElementById("brandTagImage"),n=document.getElementById("productImage"),r=document.getElementById("defectImage"),o=document.getElementById("materialTagImage"),l=document.getElementById("extraImage"),// display image when file has been selected
$("#frontImage").off("change"),e.addEventListener("change",O,{capture:!0}),$("#brandTagImage").off("change"),t.addEventListener("change",H,{capture:!0}),$("#productImage").off("change"),n.addEventListener("change",j,{capture:!0}),$("#defectImage").off("change"),r.addEventListener("change",V,{capture:!0}),$("#materialTag").off("change"),o.addEventListener("change",K,{capture:!0}),$("#extraImage").off("change"),l.addEventListener("change",U,{capture:!0}),(0,u.setupModelSearchEventListeners)(),function(){let e=document.getElementById("itemColor");e.onchange=function(){""!==this.value?e.style.color="#333":e.style.color="#929292"};// Change font color of dropdown itemAge when user selects a value
let t=document.getElementById("itemAge");t.onchange=function(){""!==this.value?t.style.color="#333":t.style.color="#929292"}}(),itemBrand.addEventListener("input",(0,i.fieldLabelToggle)("itemBrandLabel")),itemBrand.addEventListener("input",q),itemModel.addEventListener("input",(0,i.fieldLabelToggle)("itemModelLabel")),itemSize.addEventListener("input",(0,i.fieldLabelToggle)("itemSizeLabel")),itemSize.addEventListener("input",q),itemMaterial.addEventListener("input",(0,i.fieldLabelToggle)("itemMaterialLabel")),itemMaterial.addEventListener("input",q),itemOriginalPrice.addEventListener("input",(0,i.fieldLabelToggle)("itemOriginalPriceLabel")),itemAge.addEventListener("input",(0,i.fieldLabelToggle)("itemAgeLabel")),itemCondition.addEventListener("input",(0,i.fieldLabelToggle)("itemConditionLabel")),itemColor.addEventListener("change",(0,i.fieldLabelToggle)("itemColorLabel")),itemColor.addEventListener("input",q),itemUserComment.addEventListener("input",(0,i.fieldLabelToggle)("userCommentLabel")),document.getElementById("saveItemDraftButton").addEventListener("click",async()=>{document.getElementById("saveItemDraftButton").style.display="none",document.getElementById("saveDraftSpinner").style.display="flex";let e=sessionStorage.getItem("newItemId")||await (0,i.requestUniqueId)(),t=await M(e,"Draft");m=!0,a=t,document.getElementById("clearItemForm").style.display="none",document.getElementById("saveDraftSpinner").style.display="none",document.getElementById("darkOverlay").style.display="block";let n=t.images?.enhancedFrontImageSmall||t.images?.enhancedFrontImage||t.images?.frontImage;n?(document.getElementById("popUpImage").src=n,document.getElementById("popUpImageDiv").style.display="block",document.getElementById("popUpCheckmark").style.display="none"):(document.getElementById("popUpImage").src="",document.getElementById("popUpImageDiv").style.display="none",document.getElementById("popUpCheckmark").style.display="block"),document.getElementById("itemDraftSavedPopup").style.display="flex"}),document.getElementById("closeItemSavedPopup").addEventListener("click",()=>{document.getElementById("itemDraftSavedPopup").style.display="none",document.getElementById("darkOverlay").style.display="none"}),document.getElementById("popUpNewItem").addEventListener("click",()=>{Q(),location.href="/sell-item"}),document.getElementById("goToMyWardrobe").addEventListener("click",()=>{window.location.href="/private#wardrobe"}),document.getElementById("addItemButton").addEventListener("click",()=>{document.getElementById("wf-form-Add-Item").reportValidity();let e=document.getElementById("wf-form-Add-Item").querySelectorAll(":invalid"),t=e?.[0];t&&t.getBoundingClientRect().height<=1&&(t.style.cssText="width:100% !important;height:100% !important;"),setTimeout(()=>{if(e.length>0){if(!function(e){"function"==typeof jQuery&&e instanceof jQuery&&(e=e[0]);let t=e.getBoundingClientRect();return t.top>=0&&t.left>=0&&t.bottom<=(window.innerHeight/2||document.documentElement.clientHeight)&&t.right<=(window.innerWidth||document.documentElement.clientWidth)}(t)){let e=t.getBoundingClientRect().top+window.scrollY-40;window.scrollTo({top:e,behavior:"smooth"})}document.getElementById("wf-form-Add-Item").reportValidity()}},300)}),addItemForm.addEventListener("submit",()=>S()),userAddressForm.addEventListener("submit",f),(0,c.autocomplete)(document.getElementById("itemBrand"),c.brands);// Hide/Show warning about difficulty to sell certain brands
let h=document.getElementById("itemBrand"),I=document.getElementById("itemCategory");if(h.oninput=function(){shareSoldDiv.style.display="none",(0,i.checkBlockedOrLowShareSoldBrand)(this.value,I.value)},// Hide/Show extra fields for defects
itemCondition.onchange=function(){let e=this.value;"Anv\xe4nd, tecken p\xe5 slitage"==e?(defectInfoDiv.style.display="block",itemCondition.style.color="#333"):""==e?(defectInfoDiv.style.display="none",itemCondition.style.color="#929292"):(defectInfoDiv.style.display="none",itemCondition.style.color="#333")},personalId.addEventListener("input",()=>{let e=(0,d.isValidSwedishSsn)(personalId.value)?"":"Ogiltigt personnummer";personalId.setCustomValidity(e)}),(0,i.initializeCategorySelect)(),await _(),await W(),await G(),await Y(),function(){let e=new MutationObserver((e,t)=>{let n=e.find(e=>"style"===e.attributeName);n&&"none"===n.target.style.display&&P()});Array.from(document.querySelectorAll(".suggest-buttons")).forEach(t=>e.observe(t,{attributes:!0}))}(),function(){function e(e){if(m)return;let t=e.target;if(t instanceof Element){let e=k()[t.name];e!==t.value&&""!==t.value&&(document.getElementById("clearItemForm").style.display="block")}}g.id||(document.getElementById("wf-form-Add-Item").addEventListener("input",e),document.querySelector("#wf-form-Add-Item select").addEventListener("change",e))}(),function(){let e=document.getElementById("saveItemDraftDiv");function t(t){if(!g.id&&!m||g.id&&"resell"!==g.type&&"draft"!==g.type)return;let n=t.target;if(n instanceof Element){let t=a[n.name];t!==n.value&&""!==n.value&&(e.style.display="block")}}document.getElementById("wf-form-Add-Item").addEventListener("input",t),document.querySelector("#wf-form-Add-Item select").addEventListener("change",t),document.getElementById("saveItemDraft").addEventListener("click",async()=>{e.classList.add("saving");let t="resell"===g.type?await (0,i.requestUniqueId)():"draft"===g.type?g.id:a.id;await M(t,"Draft"),e.classList.remove("saving"),e.classList.add("saved"),setTimeout(()=>{e.classList.remove("saved"),e.style.display="none"},1500)})}(),y().forEach(e=>{document.getElementById(`delete${(0,i.capitalizeFirstLetter)(e)}Icon`).addEventListener("click",()=>{Z(e)})}),document.getElementById("deleteFrontImageIcon").addEventListener("click",()=>{document.getElementById("frontImage").required=!0,Z("enhancedFrontImage")}),document.getElementById("deleteBrandTagImageIcon").addEventListener("click",()=>{document.getElementById("brandTagImage").required=!0}),document.getElementById("clearItemForm").addEventListener("click",Q),window.addEventListener("scroll",function e(){window.innerHeight+window.pageYOffset>=document.body.offsetHeight-40&&(document.getElementById("bottomBarContainer").classList.add("sticky-bottom-bar"),window.removeEventListener("scroll",e))}),g.id)// Fill form if the user comes from a prefill link (re-sell item or continue with draft item)
sessionStorage.removeItem("newItemId"),localStorage.removeItem("newItem"),auth.onAuthStateChanged(function(e){e||(document.getElementById("maiIntro").style.display="block")}),document.getElementById("resellIntro").style.display="block",document.getElementById("bottomBarContainer").classList.add("sticky-bottom-bar"),document.getElementById("clearItemForm").style.display="none",("draft"===g.type||"resell"===g.type)&&(document.querySelector("#resellIntro .text-block-176").innerText="Fyll i de sista detaljerna f\xf6r att s\xe4lja ditt plagg och kontrollera skickbeskrivningen.",document.getElementById("frontImage").required=!0,document.getElementById("brandTagImage").required=!0),await D(g.id,null,"draft"===g.type),document.getElementById("triggerShowSellItemContent").click();else if(sessionStorage.getItem("itemToBeCreatedAfterSignIn")&&document.referrer.includes("/sign-in"));else if(localStorage.getItem("newItem")&&!T(JSON.parse(localStorage.getItem("newItem")))){// Saved state from a previous visit to /sell-item - restore the data
let e=JSON.parse(localStorage.getItem("newItem"));document.getElementById("frontImage").required=!0,document.getElementById("brandTagImage").required=!0,await D(null,e,!0),document.getElementById("clearItemForm").style.display="block",document.getElementById("triggerShowSellItemContent").click()}else document.getElementById("triggerShowSellItemContent").click(),document.getElementById("frontImage").required=!0,document.getElementById("brandTagImage").required=!0;// We delay the rememberUnsavedChanges call to allow any confirm/reject animations to finish
document.getElementById("wf-form-Add-Item").querySelectorAll("input").forEach(e=>{e.addEventListener("input",P)}),document.getElementById("wf-form-Add-Item").querySelectorAll('input[type="radio"]').forEach(e=>{e.addEventListener("change",P)}),document.getElementById("wf-form-Add-Item").querySelectorAll('input[type="checkbox"]').forEach(e=>{e.addEventListener("change",P)}),// We delay the rememberUnsavedChanges call to allow any confirm/reject animations to finish
document.getElementById("wf-form-Add-Item").querySelectorAll("select").forEach(e=>{e.addEventListener("change",P)}),document.getElementById("wf-form-Add-Item").querySelectorAll("textarea").forEach(e=>{e.addEventListener("input",P)}),window.addEventListener("pageshow",e=>{e.persisted&&localStorage.getItem("newItem")&&setTimeout(async()=>{await D(null,JSON.parse(localStorage.getItem("newItem")),!0)},10)})}async function S(){let e="draft"===g.type?g.id:sessionStorage.getItem("newItemId")||await (0,i.requestUniqueId)();try{document.getElementById("addItemFormDiv").style.display="none",document.getElementById("loadingDiv").style.display="flex",document.getElementById("clearItemForm").style.display="none",document.getElementById("saveItemDraftDiv").style.display="none";let t=await M(e),n=await x(e,t);0===r&&analytics.track("User Activated"),location.href=n}catch(e){errorHandler.report(e),console.error("addItem failed",e)}}function b({humanCheckNeeded:e,newMinMaxLog:t,lowValueSegment:n,lowValueCategory:a}){return e||t.match(/accept price is above max/i)&&!n&&!a}async function v(e,t){let{minPrice:n,maxPrice:a,decline:r,humanCheckNeeded:o,humanCheckExplanation:i,willNotSell:l,soldPrice:s,version:d,newMinPriceEstimate:c,newMaxPriceEstimate:u,newMinMaxLog:m,adjustmentAllowed:g,newBrand:f,newBrandCategory:p,valuatedBrandItems:y,brandMeanMax:h,brandAccuracy:I,brandCategoryAccuracy:S,fewBrand:v,brandMeanSold:B,brandCategoryMeanSold:x,highPriceVarBrandCategory:E,brandShareSold:k}=t||{};if(!n&&!r)return;let C={mlValuation:{decline:r,humanCheckNeeded:o,minPriceEstimate:n,maxPriceEstimate:a,humanCheckExplanation:i,willNotSellPrediction:l,soldPriceEstimate:s,modelVersion:d?.toString(),newMinPriceEstimate:c,newMaxPriceEstimate:u,newMinMaxLog:m,adjustmentAllowed:g,newBrand:f,newBrandCategory:p,valuatedBrandItems:y,brandMeanMax:h,brandAccuracy:I,brandCategoryAccuracy:S,fewBrand:v,brandMeanSold:B,brandCategoryMeanSold:x,highPriceVarBrandCategory:E,brandShareSold:k},...r||b(t)?{}:{valuationStatus:"Completed",valuationDate:new Date().toISOString(),infoRequests:{price:{status:"Active",response:"",description:"Vi b\xf6rjar med startpriset, och justerar successivt ner till l\xe4gsta priset under s\xe4ljperioden p\xe5 30 dagar. V\xe4rderingen utg\xe5r fr\xe5n vad liknande s\xe5lts f\xf6r.",minPrice:c||n,maxPrice:u||a}}}};if(sessionStorage.getItem("itemToBeCreatedAfterSignIn")){let e=JSON.parse(sessionStorage.getItem("itemToBeCreatedAfterSignIn"));sessionStorage.setItem("itemToBeCreatedAfterSignIn",JSON.stringify({id:e.id,item:{...e.item,...C}}))}else{await firebase.app().functions("europe-west1").httpsCallable("saveItemValuationFields")({itemId:e,...C});let t=JSON.parse(localStorage.getItem("latestItemCreated"));localStorage.setItem("latestItemCreated",JSON.stringify({...t,...C}))}}async function B(e,t,n){let a={valuationStatus:"Completed",valuationDate:new Date().toISOString(),infoRequests:{price:{status:"Active",response:"",description:"Vi b\xf6rjar med startpriset, och justerar successivt ner till l\xe4gsta priset under s\xe4ljperioden p\xe5 30 dagar. V\xe4rderingen utg\xe5r fr\xe5n vad liknande s\xe5lts f\xf6r.",minPrice:e.minPriceEstimate,maxPrice:e.maxPriceEstimate,type:"Valuation",source:"createdFromItem",adjustmentAllowed:!0}}};if(sessionStorage.getItem("itemToBeCreatedAfterSignIn"))sessionStorage.setItem("itemToBeCreatedAfterSignIn",JSON.stringify({id:t.id,item:{...t.item,...a}}));else{await firebase.app().functions("europe-west1").httpsCallable("saveItemValuationFields")({itemId:n,...a});let e=JSON.parse(localStorage.getItem("latestItemCreated"));localStorage.setItem("latestItemCreated",JSON.stringify({...e,...a}))}}async function x(e,t){if(!e&&!t)return console.error("No item and no itemId, unexpected!!"),"/item-confirmation";if(g.id){let n=await firebase.app().functions("europe-west1").httpsCallable("getItem")({itemId:g.id}),a=n.data;if("Sold"===a.status)return await B(a,t,e),"/item-valuation"}try{let n=await firebase.app().functions("europe-west1").httpsCallable("itemMlValuation")({itemId:e,item:t}),{minPrice:a,maxPrice:r,decline:o}=n.data||{};return await v(e,n.data),E(a&&r,o,b(n.data))}catch(e){console.error("Failed to get ml valuation",e)}return E()}function E(e,t,n){if(!e||n){if(sessionStorage.getItem("itemToBeCreatedAfterSignIn"))return"/sign-in";let e=user.current?.phoneNumber?.length;return e?"/item-confirmation":"/user-contact"}return"/item-valuation"}function k(){return{acceptPrice:null,age:null,brand:null,category:null,color:null,condition:null,defectDescription:null,defects:[],images:{},material:null,model:null,originalPrice:null,userValuationApproval:!0,sex:"Woman",size:null,userComment:null}}function C(){let e="",t=new Date,n=itemSize.value,a=itemMaterial.value?itemMaterial.value.trim():"",r=itemBrand.value?itemBrand.value.trim():"",o=itemModel.value?itemModel.value.trim():"",i=Number(itemOriginalPrice.value),l=itemAge.value,s=itemCondition.value,d=itemDefectDescription.value?itemDefectDescription.value.trim():"",c=itemUserComment.value?itemUserComment.value.trim():"",u=Number(itemLowestAcceptPrice.value),m=new Map().set("hole",hole.checked).set("stain",stain.checked).set("lostFit",lostFit.checked).set("nopprig",nopprig.checked).set("threadUp",threadUp.checked).set("colorChange",colorChange.checked).set("otherDefect",otherDefect.checked),g=[];"Anv\xe4nd, tecken p\xe5 slitage"===s&&m.forEach((e,t)=>{if(e){let e=p().get(t);g.push(e)}});for(var f=document.getElementsByName("Sex"),y=0;y<f.length;y++)f[y].checked&&(e=f[y].id);let h=document.getElementById("findModelBoxFilled"),I={};if("flex"===h.style.display){// There is a current model selected grab the cover image and id from it
let e=JSON.parse(h.getAttribute("data-model"));I={modelCoverImageUrl:e.coverImage,atModelVariantId:e.atVariantId}}let S=JSON.parse(localStorage.getItem("newItem")||"{}").images;return{user:authUser.current?.uid||null,createdAt:t.toISOString(),status,shippingStatus:"Not sent",sex:e,size:n,material:a,color:itemColor.value,category:itemCategory.value,brand:r,model:o,originalPrice:i,age:l,condition:s,defects:g,defectDescription:d,userComment:c,acceptPrice:u,preferences:{userValuationApproval:!0},...I,images:S}}async function w(){// If first time: User chooses shipping method preference in sell item form
let e="Service point";return user.current?.preferences?.shippingMethod?e=user.current?.preferences?.shippingMethod:authUser.current?await firebase.app().functions("europe-west1").httpsCallable("updateFirebaseUser")({preferences:{shippingMethod:e}}):sessionStorage.setItem("shippingMethod",e),e}async function M(e,t="New"){let{modelCoverImageUrl:n,images:a,...r}=C(),o=await w();n&&(a.modelImage=n);let i=g.id&&"draft"!==g.type?{createdFromItem:g.id}:{},l="Draft"===t?{draftSource:Object.keys(i).length?"Mai purchase":"Sell item"}:{},s={...r,status:t,...l,shippingMethod:o,images:a,...i,version:"2"};if(authUser.current){let t=await firebase.app().functions("europe-west1").httpsCallable("createItem")({id:e,item:s});localStorage.removeItem("newItem"),sessionStorage.removeItem("newItemId"),localStorage.setItem("latestItemCreated",JSON.stringify(t.data))}else sessionStorage.setItem("itemToBeCreatedAfterSignIn",JSON.stringify({id:e,item:s}));return{...s,id:e}}async function L(){let e=JSON.parse(sessionStorage.getItem("itemToBeCreatedAfterSignIn"));sessionStorage.removeItem("itemToBeCreatedAfterSignIn"),sessionStorage.removeItem("newItemId"),await firebase.app().functions("europe-west1").httpsCallable("createItem")(e),localStorage.removeItem("newItem"),e.item.id=e.id,localStorage.setItem("latestItemCreated",JSON.stringify(e.item))}let A=()=>!(localStorage.getItem("latestItemCreated")||m||g.id);function P(){if(!A())return;let{user:e,createdAt:t,status:n,shippingStatus:a,modelVariantFields:r,...o}=C(),i=Object.keys(o).reduce((e,t)=>(e[t]=""===o[t]?null:o[t],e),{});i.defects=i.defects?i.defects:[],i.userValuationApproval=!0,delete i.preferences,i.acceptPrice=i.acceptPrice&&i.acceptPrice>0?i.acceptPrice:null,i.originalPrice=i.originalPrice&&i.originalPrice>0?i.originalPrice:null,["itemBrand","itemSize","itemMaterial","itemColor"].forEach(e=>{let t=document.getElementById(e).parentNode.querySelector(".suggest-buttons")||document.getElementById(e).parentNode.parentNode.querySelector(".suggest-buttons");t?.style?.display==="block"&&(i[`${e}Confirm`]=!0)}),T(i)?localStorage.removeItem("newItem"):localStorage.setItem("newItem",JSON.stringify(i))}function T(e){return function(e,t){for(let n in t)if(n in e){if(t[n]instanceof Object){if(JSON.stringify(t[n])!==JSON.stringify(e[n]))return!1;continue}if(e[n]!==t[n])return!1}return!0}(e,k())}function N(e,t,n){if(t&&n){let t=document.getElementById(e).parentNode.querySelector(".suggest-buttons")||document.getElementById(e).parentNode.parentNode.querySelector(".suggest-buttons");t.style.display="block",document.getElementById(e).setCustomValidity("Bekr\xe4fta eller \xe4ndra v\xe4rdet")}}async function D(e,t=null,n=!1){try{let r={data:t},o=null;t||([r,o]=await Promise.all([firebase.app().functions("europe-west1").httpsCallable("getItem")({itemId:e}),fetch(`https://getatitem-heypmjzjfq-ew.a.run.app?itemId=${e}`)]),a=r);let l=await o?.json()||{},s=r.data,d=s.images||{},c=s.originalPrice;// Populate images
for(let e in c<=0&&(c=null),d){let t=d[`${e}Small`]||d[`${e}Medium`]||d[e]||d[`${e}Large`],n=d[e]||d[`${e}Large`]||d[`${e}Medium`]||d[`${e}Small`];y().includes(e)&&((0,i.rememberNewItemImageField)(e,n,t),"frontImage"===e&&(d.enhancedFrontImage?(t=d.enhancedFrontImageSmall||d.enhancedFrontImageMedium||d.enhancedFrontImage||d.enhancedFrontImageLarge,n=d.enhancedFrontImage||d.enhancedFrontImageLarge||d.enhancedFrontImageMedium||d.enhancedFrontImageSmall,(0,i.rememberNewItemImageField)("enhancedFrontImage",n,t)):(function(e){let t=new MutationObserver(e),n=document.getElementById("loadingDiv");t.observe(n,{attributeFilter:["style"]})}(()=>(0,i.showLoadingIcon)(e)),// Don't await here to don't block the form from showing with the front image
...
itemBrand.value=s.brand||"",N("itemBrand",n,s.itemBrandConfirm),// Don't use the setFieldValue for the brand since that triggers a dropdown to open
document.getElementById("itemBrandLabel").style.display=s.brand?"inline-block":"none",(0,u.setFieldValue)("itemSize",s.size),N("itemSize",n,s.itemSizeConfirm),(0,u.setFieldValue)("itemMaterial",s.material),N("itemMaterial",n,s.itemMaterialConfirm),(0,u.setFieldValue)("itemModel",s.model||l?.model),(0,u.setFieldValue)("itemOriginalPrice",c||l?.originalPrice),n&&((0,u.setFieldValue)("itemUserComment",s.userComment),(0,u.setFieldValue)("itemDefectDescription",s.defectDescription),(0,u.setFieldValue)("itemLowestAcceptPrice",s.acceptPrice<=0?null:s.acceptPrice),F(itemCondition,s.condition)),g.id&&"Sold"===s.status&&(document.getElementById("priceSettings").style.display="none"),// Populate select fields
F(itemAge,s.age),F(itemColor,s.color||l?.color),N("itemColor",n,s.itemColorConfirm),itemCondition.selectedIndex>=0&&"Anv\xe4nd, tecken p\xe5 slitage"===itemCondition.options[itemCondition.selectedIndex].text&&(defectInfoDiv.style.display="block");let m=$("#itemCategory");m.val(s.category),m.trigger("change"),s.sex?(document.getElementById("Woman").previousElementSibling.classList.remove("w--redirected-checked"),document.getElementById("Woman").checked=!1,document.getElementById(s.sex).previousElementSibling.classList.add("w--redirected-checked"),document.getElementById(s.sex).checked=!0):(document.getElementById("Woman").previousElementSibling.classList.add("w--redirected-checked"),document.getElementById("Woman").checked=!0),n&&p().forEach((e,t)=>{s.defects&&s.defects.includes(e)&&(document.getElementById(t).previousElementSibling.classList.add("w--redirected-checked"),document.getElementById(t).checked=!0)})}catch(e){console.error("Error getting item document:",e),errorHandler.report(e)}document.getElementById("loadingDiv").style.display="none"}function F(e,t){let n=Array.from(e.options).map(e=>e.attributes.value.value).indexOf(t);n>0?(e.selectedIndex=n,e.style.color="#333"):(e.selectedIndex=0,e.style.color="#929292"),e.dispatchEvent(new Event("input")),e.dispatchEvent(new Event("change"))}let R={black:"Black",white:"White",gray:"Grey",blue:"Blue",dark_blue:"Navy","multicolor/colorful":"Multicolour",red:"Red",pink:"Pink",brown:"Brown",beige:"Beige",light_blue:"Blue",green:"Green",silver:"Silver",purple:"Purple",maroon:"Burgundy",gold:"Gold",orange:"Orange",yellow:"Yellow",teal:"Turquoise",olive:"Green",cyan:"Turquoise",magenta:"Pink",mustard:"Yellow"};async function O(e){let t=this.files[0];if(t){e.stopPropagation();let n=await (0,i.uploadImageAndShowPreview)(t,"frontImage");if(!n||0===Object.keys(n).length)return;let a=[];a.push(J(n),z(n),(0,i.enhanceFrontImage)(n)),await Promise.all(a),P()}}async function H(e){let t=this.files[0];if(t){e.stopPropagation();let n=await (0,i.uploadImageAndShowPreview)(t,"brandTagImage");(0,i.showDeleteImageIcon)("brandTagImage"),await z(n),P()}}async function j(e){let t=this.files[0];if(t){e.stopPropagation();let n=await (0,i.uploadImageAndShowPreview)(t,"productImage");(0,i.showDeleteImageIcon)("productImage"),await z(n),P()}}async function V(e){let t=this.files[0];if(t){e.stopPropagation();let n=await (0,i.uploadImageAndShowPreview)(t,"defectImage");(0,i.showDeleteImageIcon)("defectImage"),await z(n),P()}}async function K(e){let t=this.files[0];if(t){e.stopPropagation();let n=await (0,i.uploadImageAndShowPreview)(t,"materialTagImage");(0,i.showDeleteImageIcon)("materialTagImage"),await z(n),P()}}async function U(e){let t=this.files[0];if(t){e.stopPropagation();let n=await (0,i.uploadImageAndShowPreview)(t,"extraImage");(0,i.showDeleteImageIcon)("extraImage"),await z(n),P()}}function q(e){e.currentTarget.setCustomValidity("");let t=e.currentTarget.parentNode.querySelector(".suggest-buttons")||e.currentTarget.parentNode.parentNode.querySelector(".suggest-buttons");t.style.display="none"}async function z(e){try{if(document.querySelector("#itemBrand").value.length&&document.querySelector("#itemMaterial").value.length&&document.querySelector("#itemSize").value.length)return;let t=await firebase.app().functions("europe-west1").httpsCallable("detectItemBrandAndMaterialAndSize")({imageUrl:e});!document.querySelector("#itemBrand").value.length&&t.data?.brand&&(document.querySelector("#itemBrand").value=t.data.brand,document.querySelector("#itemBrand").setCustomValidity("Bekr\xe4fta eller \xe4ndra m\xe4rket"),document.getElementById("itemBrandLabel").style.display="inline-block",document.querySelector("#brandSuggestButtons").style.display="block",document.querySelector("#itemBrand").dispatchEvent(new Event("change")),analytics.track("Element Viewed",{elementID:"brandSuggestButtons"})),!document.querySelector("#itemMaterial").value.length&&t.data?.materials&&(document.querySelector("#itemMaterial").value=t.data.materials,document.querySelector("#itemMaterial").setCustomValidity("Bekr\xe4fta eller \xe4ndra materialet"),document.getElementById("itemMaterialLabel").style.display="inline-block",document.querySelector("#materialSuggestButtons").style.display="block",document.querySelector("#itemMaterial").dispatchEvent(new Event("change")),analytics.track("Element Viewed",{elementID:"materialSuggestButtons"})),!document.querySelector("#itemSize").value.length&&t.data?.size&&(document.querySelector("#itemSize").value=t.data.size,document.querySelector("#itemSize").setCustomValidity("Bekr\xe4fta eller \xe4ndra storlek"),document.getElementById("itemSizeLabel").style.display="inline-block",document.querySelector("#sizeSuggestButtons").style.display="block",document.querySelector("#itemSize").dispatchEvent(new Event("change")),analytics.track("Element Viewed",{elementID:"sizeSuggestButtons"}))}catch(e){errorHandler.report(e),console.log("Error calling detectItemBrandAndMaterialAndSize",e)}}async function J(e){if(""===document.querySelector("#itemColor").value)try{let t=await firebase.app().functions("europe-west1").httpsCallable("detectItemColor")({imageUrl:e});if(!t.data?.colors||!t.data.colors.length){console.log("Unable to detect product color");return}if(t.data.colors.length>2)document.querySelector("#itemColor").value="Multicolour";else if(R[t.data.colors?.[0]])document.querySelector("#itemColor").value=R[t.data.colors?.[0]];else{console.log("Unable to set color from",t.data.colors?.[0]);return}document.querySelector("#itemColor").setCustomValidity("Bekr\xe4fta eller \xe4ndra f\xe4rgen"),document.querySelector("#colorSuggestButtons").style.display="block",document.querySelector("#itemColor").dispatchEvent(new Event("change")),analytics.track("Element Viewed",{elementID:"colorSuggestButtons"})}catch(e){errorHandler.report(e),console.log("Error calling detectItemColor",e)}}async function G(){document.getElementById("rejectMaterial").addEventListener("click",()=>{document.querySelector("#itemMaterial").value="",document.querySelector("#materialSuggestButtons").style.display="none",(0,i.fieldLabelToggle)("itemMaterialLabel"),document.querySelector("#itemMaterial").setCustomValidity("")}),document.getElementById("confirmMaterial").addEventListener("click",()=>{document.querySelector("#itemMaterial").setCustomValidity("")})}async function W(){document.getElementById("rejectBrand").addEventListener("click",()=>{document.querySelector("#itemBrand").value="",document.querySelector("#brandSuggestButtons").style.display="none",document.querySelector("#itemBrand").setCustomValidity(""),(0,i.fieldLabelToggle)("itemBrandLabel")}),document.getElementById("confirmBrand").addEventListener("click",()=>{document.querySelector("#itemBrand").setCustomValidity(""),document.querySelector("#itemBrand").setCustomValidity("")})}async function Y(){document.getElementById("rejectSize").addEventListener("click",()=>{document.querySelector("#itemSize").value="",document.querySelector("#sizeSuggestButtons").style.display="none",(0,i.fieldLabelToggle)("itemSizeLabel"),document.querySelector("#itemSize").setCustomValidity("")}),document.getElementById("confirmSize").addEventListener("click",()=>{document.querySelector("#itemSize").setCustomValidity("")})}async function _(){document.getElementById("rejectColor").addEventListener("click",()=>{document.querySelector("#itemColor").value="",document.querySelector("#colorSuggestButtons").style.display="none",(0,i.fieldLabelToggle)("itemColorLabel"),document.querySelector("#itemColor").setCustomValidity("")}),document.getElementById("confirmColor").addEventListener("click",()=>{document.querySelector("#itemColor").setCustomValidity("")})}function Q(){document.getElementById("clearItemForm").style.display="none",y().forEach(e=>{document.getElementById(`${e}Preview`).style.backgroundImage="",(0,i.showImageState)(e,"default-state")}),(0,u.setFieldValue)("itemBrand",null),Array.from(document.querySelectorAll(".suggest-buttons")).forEach(e=>e.style.display="none"),(0,u.setFieldValue)("itemSize",null),(0,u.setFieldValue)("itemMaterial",null),(0,u.setFieldValue)("itemModel",null),(0,u.setFieldValue)("itemOriginalPrice",null),(0,u.setFieldValue)("itemUserComment",null),(0,u.setFieldValue)("itemDefectDescription",null),(0,u.setFieldValue)("itemLowestAcceptPrice",null),F(itemAge,""),F(itemColor,""),F(itemCondition,""),defectInfoDiv.style.display="none";let e=$("#itemCategory");e.val(""),e.trigger("change"),// Populate radio-buttons
 ...
 */function y(e,t,n){let a,r;let o=e.size,i=g.getEncodedBits(t,n);for(a=0;a<15;a++)r=(i>>a&1)==1,a<6?e.set(a,8,r,!0):a<8?e.set(a+1,8,r,!0):e.set(o-15+a,8,r,!0),a<8?e.set(8,o-a-1,r,!0):a<9?e.set(8,15-a-1+1,r,!0):e.set(8,15-a-1,r,!0);// fixed module
e.set(o-8,8,1,!0)}/**
 * QR Code
 *
...
h=r.from(t.errorCorrectionLevel,r.M),n=m.from(t.version),g=d.from(t.maskPattern),t.toSJISFunc&&a.setToSJISFunction(t.toSJISFunc)),/**
 ...
 */function(e,t,n,r){let g;if(Array.isArray(e))g=p.fromArray(e);else if("string"==typeof e){let a=t;if(!a){let t=p.rawSplit(e);// Estimate best version that can contain raw splitted segments
...
let i=a.getSymbolTotalCodewords(t),l=c.getTotalCodewordsCount(t,n),s=i-l,d=c.getBlocksCount(t,n),m=i%d,g=d-m,f=Math.floor(i/d),p=Math.floor(s/d),y=p+1,h=f-p,I=new u(h),S=0,b=Array(d),v=Array(d),B=0,x=new Uint8Array(e.buffer);// Divide the buffer into the required number of blocks
...
for(r=0;r<h;r++)for(o=0;o<d;o++)E[k++]=v[o][r];return E}(r,e,t))}(t,n,g),S=a.getSymbolSize(t),b=new i(S);return(// Add function modules
/**
