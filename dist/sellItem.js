...
let i=a.getSymbolTotalCodewords(t),l=c.getTotalCodewordsCount(t,n),s=i-l,d=c.getBlocksCount(t,n),m=i%d,g=d-m,f=Math.floor(i/d),h=Math.floor(s/d),p=h+1,y=f-h,I=new u(y),S=0,b=Array(d),B=Array(d),v=0,x=new Uint8Array(e.buffer);// Divide the buffer into the required number of blocks
...
B[e]=I.encode(b[e]),S+=t,v=Math.max(v,t)}// Create final data
// Interleave the data and error correction codewords from each block
let E=new Uint8Array(i),k=0;// Add data codewords
for(r=0;r<v;r++)for(o=0;o<d;o++)r<b[o].length&&(E[k++]=b[o][r]);// Apped EC codewords
for(r=0;r<y;r++)for(o=0;o<d;o++)E[k++]=B[o][r];return E}(r,e,t))}(t,n,g),S=a.getSymbolSize(t),b=new i(S);return(// Add function modules
/**
