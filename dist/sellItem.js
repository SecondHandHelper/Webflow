...
var u=d(n);// CommonJS
"object"==typeof exports&&"undefined"!=typeof module?module.exports=u:"function"==typeof define&&define.amd?define(function(){return u}):o&&(this[o]=u)}}({"42EGR":[function(e,t,n){let a;var o,r=e("@parcel/transformer-js/src/esmodule-helpers.js");r.defineInteropFlag(n),r.export(n,"isNoBgImage",()=>ee);var i=e("./sellItemHelpers"),l=e("qrcode"),s=r.interopDefault(l),d=e("./general"),c=e("./autocomplete-brands"),u=e("./sellItemModelSearch");let m=!1,g=getParamsObject();async function f(){// Grab values from form
...
if(document.referrer.includes("/sign-in")){document.getElementById("loadingDiv").style.display="flex",document.getElementById("creatingItemText").style.display="block",await A();let e=sessionStorage.getItem("shippingMethod");e&&await firebase.app().functions("europe-west1").httpsCallable("updateFirebaseUser")({preferences:{shippingMethod:e}});let t=user.current?.phoneNumber?.length;return location.href=t?"/item-confirmation":"/user-contact"}sessionStorage.removeItem("itemToBeCreatedAfterSignIn")}// Get user's item count to be able to send 'User Activated' event
let e=await getItems(authUser.current.uid);o=e.docs.filter(e=>e.data()?.status!=="Draft").length}async function I(){let e,t,n,o,r,l;let p=document.getElementById("qrCanvas");p&&(0,s.default).toCanvas(p,window.location.href,function(e){e&&console.error(e),console.log("success!")}),localStorage.removeItem("latestItemCreated"),sessionStorage.removeItem("itemValuation"),e=document.getElementById("frontImage"),t=document.getElementById("brandTagImage"),n=document.getElementById("productImage"),o=document.getElementById("defectImage"),r=document.getElementById("materialTagImage"),l=document.getElementById("extraImage"),// display image when file has been selected
$("#frontImage").off("change"),e.addEventListener("change",H,{capture:!0}),$("#brandTagImage").off("change"),t.addEventListener("change",j,{capture:!0}),$("#productImage").off("change"),n.addEventListener("change",V,{capture:!0}),$("#defectImage").off("change"),o.addEventListener("change",K,{capture:!0}),$("#materialTag").off("change"),r.addEventListener("change",U,{capture:!0}),$("#extraImage").off("change"),l.addEventListener("change",q,{capture:!0}),(0,u.setupModelSearchEventListeners)(),function(){let e=document.getElementById("itemColor");e.onchange=function(){""!==this.value?e.style.color="#333":e.style.color="#929292"};// Change font color of dropdown itemAge when user selects a value
let t=document.getElementById("itemAge");t.onchange=function(){""!==this.value?t.style.color="#333":t.style.color="#929292"}}(),itemBrand.addEventListener("input",(0,i.fieldLabelToggle)("itemBrandLabel")),itemBrand.addEventListener("input",z),itemModel.addEventListener("input",(0,i.fieldLabelToggle)("itemModelLabel")),itemSize.addEventListener("input",(0,i.fieldLabelToggle)("itemSizeLabel")),itemSize.addEventListener("input",z),itemMaterial.addEventListener("input",(0,i.fieldLabelToggle)("itemMaterialLabel")),itemMaterial.addEventListener("input",z),itemOriginalPrice.addEventListener("input",(0,i.fieldLabelToggle)("itemOriginalPriceLabel")),itemAge.addEventListener("input",(0,i.fieldLabelToggle)("itemAgeLabel")),itemCondition.addEventListener("input",(0,i.fieldLabelToggle)("itemConditionLabel")),itemColor.addEventListener("change",(0,i.fieldLabelToggle)("itemColorLabel")),itemColor.addEventListener("input",z),itemUserComment.addEventListener("input",(0,i.fieldLabelToggle)("userCommentLabel")),document.getElementById("saveItemDraftButton").addEventListener("click",async()=>{document.getElementById("saveItemDraftButton").style.display="none",document.getElementById("saveDraftSpinner").style.display="flex";let e=sessionStorage.getItem("newItemId")||await (0,i.requestUniqueId)(),t=await M(e,"Draft");m=!0,a=t,document.getElementById("clearItemForm").style.display="none",document.getElementById("saveDraftSpinner").style.display="none",document.getElementById("darkOverlay").style.display="block";let n=t.images?.enhancedFrontImageSmall||t.images?.enhancedFrontImage||t.images?.frontImage;n?(document.getElementById("popUpImage").src=n,document.getElementById("popUpImageDiv").style.display="block",document.getElementById("popUpCheckmark").style.display="none"):(document.getElementById("popUpImage").src="",document.getElementById("popUpImageDiv").style.display="none",document.getElementById("popUpCheckmark").style.display="block"),document.getElementById("itemDraftSavedPopup").style.display="flex"}),document.getElementById("closeItemSavedPopup").addEventListener("click",()=>{document.getElementById("itemDraftSavedPopup").style.display="none",document.getElementById("darkOverlay").style.display="none"}),document.getElementById("popUpNewItem").addEventListener("click",()=>{Z(),location.href="/sell-item"}),document.getElementById("goToMyWardrobe").addEventListener("click",()=>{window.location.href="/private#wardrobe"}),document.getElementById("addItemButton").addEventListener("click",()=>{document.getElementById("wf-form-Add-Item").reportValidity();let e=document.getElementById("wf-form-Add-Item").querySelectorAll(":invalid"),t=e?.[0];t&&t.getBoundingClientRect().height<=1&&(t.style.cssText="width:100% !important;height:100% !important;"),setTimeout(()=>{if(e.length>0){if(!function(e){"function"==typeof jQuery&&e instanceof jQuery&&(e=e[0]);let t=e.getBoundingClientRect();return t.top>=0&&t.left>=0&&t.bottom<=(window.innerHeight/2||document.documentElement.clientHeight)&&t.right<=(window.innerWidth||document.documentElement.clientWidth)}(t)){let e=t.getBoundingClientRect().top+window.scrollY-40;window.scrollTo({top:e,behavior:"smooth"})}document.getElementById("wf-form-Add-Item").reportValidity()}},300)}),addItemForm.addEventListener("submit",()=>S()),userAddressForm.addEventListener("submit",f),(0,c.autocomplete)(document.getElementById("itemBrand"),c.brands);// Hide/Show warning about difficulty to sell certain brands
...
let e="Service point";return user.current?.preferences?.shippingMethod?e=user.current?.preferences?.shippingMethod:authUser.current?await firebase.app().functions("europe-west1").httpsCallable("updateFirebaseUser")({preferences:{shippingMethod:e}}):sessionStorage.setItem("shippingMethod",e),e}async function M(e,t="New"){let{modelCoverImageUrl:n,images:a,...o}=C(),r=await w();n&&(a.modelImage=n);let i=g.id&&"draft"!==g.type?{createdFromItem:g.id}:{},l="Draft"===t?{draftSource:Object.keys(i).length?"Mai purchase":"Sell item"}:{},s={...o,status:t,...l,shippingMethod:r,images:a,...i,version:"2"};if(authUser.current){let t=await firebase.app().functions("europe-west1").httpsCallable("createItem")({id:e,item:s});L(),localStorage.removeItem("newItem"),sessionStorage.removeItem("newItemId"),localStorage.setItem("latestItemCreated",JSON.stringify(t.data))}else sessionStorage.setItem("itemToBeCreatedAfterSignIn",JSON.stringify({id:e,item:s}));return{...s,id:e}}function L(){0===o&&"noCommission"===getCookie("noCommissionCampaignCookie")&&db.collection("users").doc(authUser.current.uid).update({oneTimeCommissionFreeCoupon:!0})}async function A(){let e=JSON.parse(sessionStorage.getItem("itemToBeCreatedAfterSignIn"));sessionStorage.removeItem("itemToBeCreatedAfterSignIn"),sessionStorage.removeItem("newItemId"),await firebase.app().functions("europe-west1").httpsCallable("createItem")(e),L(),localStorage.removeItem("newItem"),e.item.id=e.id,localStorage.setItem("latestItemCreated",JSON.stringify(e.item))}let P=()=>!(localStorage.getItem("latestItemCreated")||m||g.id);function T(){if(!P())return;let{user:e,createdAt:t,status:n,shippingStatus:a,modelVariantFields:o,...r}=C(),i=Object.keys(r).reduce((e,t)=>(e[t]=""===r[t]?null:r[t],e),{});i.defects=i.defects?i.defects:[],i.userValuationApproval=!0,delete i.preferences,i.acceptPrice=i.acceptPrice&&i.acceptPrice>0?i.acceptPrice:null,i.originalPrice=i.originalPrice&&i.originalPrice>0?i.originalPrice:null,["itemBrand","itemSize","itemMaterial","itemColor"].forEach(e=>{let t=document.getElementById(e).parentNode.querySelector(".suggest-buttons")||document.getElementById(e).parentNode.parentNode.querySelector(".suggest-buttons");t?.style?.display==="block"&&(i[`${e}Confirm`]=!0)}),N(i)?localStorage.removeItem("newItem"):localStorage.setItem("newItem",JSON.stringify(i))}function N(e){return function(e,t){for(let n in t)if(n in e){if(t[n]instanceof Object){if(JSON.stringify(t[n])!==JSON.stringify(e[n]))return!1;continue}if(e[n]!==t[n])return!1}return!0}(e,k())}function D(e,t,n){if(t&&n){let t=document.getElementById(e).parentNode.querySelector(".suggest-buttons")||document.getElementById(e).parentNode.parentNode.querySelector(".suggest-buttons");t.style.display="block",document.getElementById(e).setCustomValidity("Bekr\xe4fta eller \xe4ndra v\xe4rdet")}}async function F(e,t=null,n=!1){try{let o={data:t},r=null;t||([o,r]=await Promise.all([firebase.app().functions("europe-west1").httpsCallable("getItem")({itemId:e}),fetch(`https://getatitem-heypmjzjfq-ew.a.run.app?itemId=${e}`)]),a=o);let l=await r?.json()||{},s=o.data,d=s.images||{},c=s.originalPrice;// Populate images
 ...
 */function h(e,t,n){let a,o;let r=e.size,i=g.getEncodedBits(t,n);for(a=0;a<15;a++)o=(i>>a&1)==1,a<6?e.set(a,8,o,!0):a<8?e.set(a+1,8,o,!0):e.set(r-15+a,8,o,!0),a<8?e.set(8,r-a-1,o,!0):a<9?e.set(8,15-a-1+1,o,!0):e.set(8,15-a-1,o,!0);// fixed module
e.set(r-8,8,1,!0)}/**
 * QR Code
 *
...
y=o.from(t.errorCorrectionLevel,o.M),n=m.from(t.version),g=d.from(t.maskPattern),t.toSJISFunc&&a.setToSJISFunction(t.toSJISFunc)),/**
...
for(o=0;o<B;o++)for(r=0;r<d;r++)o<b[r].length&&(E[k++]=b[r][o]);// Apped EC codewords
for(o=0;o<y;o++)for(r=0;r<d;r++)E[k++]=v[r][o];return E}(o,e,t))}(t,n,g),S=a.getSymbolSize(t),b=new i(S);return(// Add function modules
/**
 ...
 * @param  {BitMatrix} matrix  Modules matrix
 * @param  {Number}    version QR Code version
 */function(e,t){let n=e.size,a=s.getPositions(t);for(let t=0;t<a.length;t++){let o=a[t][0],r=a[t][1];for(let t=-1;t<=7;t++)if(!(o+t<=-1)&&!(n<=o+t))for(let a=-1;a<=7;a++)r+a<=-1||n<=r+a||(t>=0&&t<=6&&(0===a||6===a)||a>=0&&a<=6&&(0===t||6===t)||t>=2&&t<=4&&a>=2&&a<=4?e.set(o+t,r+a,!0,!0):e.set(o+t,r+a,!1,!0))}}(b,t),/**
 ...
 * @param  {BitMatrix} matrix  Modules matrix
 * @param  {Number}    version QR Code version
 */function(e,t){let n=l.getPositions(t);for(let t=0;t<n.length;t++){let a=n[t][0],o=n[t][1];for(let t=-2;t<=2;t++)for(let n=-2;n<=2;n++)-2===t||2===t||-2===n||2===n||0===t&&0===n?e.set(a+t,o+n,!0,!0):e.set(a+t,o+n,!1,!0)}}(b,t),// Add temporary dummy bits for format info just to set them as reserved.
 ...
 * @param  {BitMatrix} matrix  Modules matrix
 * @param  {Number}    version QR Code version
 */function(e,t){let n,a,o;let r=e.size,i=m.getEncodedBits(t);for(let t=0;t<18;t++)n=Math.floor(t/3),a=t%3+r-8-3,o=(i>>t&1)==1,e.set(n,a,o,!0),e.set(a,n,o,!0)}(b,t),// Add data codewords
/**
 * Add encoded data bits to matrix
 *
 * @param  {BitMatrix}  matrix Modules matrix
 * @param  {Uint8Array} data   Data codewords
 */function(e,t){let n=e.size,a=-1,o=n-1,r=7,i=0;for(let l=n-1;l>0;l-=2)for(6===l&&l--;;){for(let n=0;n<2;n++)if(!e.isReserved(o,l-n)){let a=!1;i<t.length&&(a=(t[i]>>>r&1)==1),e.set(o,l-n,a),-1==--r&&(i++,r=7)}if((o+=a)<0||n<=o){o-=a,a=-a;break}}}(b,I),isNaN(o)&&(o=d.getBestMask(b,h.bind(null,b,n))),// Apply mask pattern
d.applyMask(o,b),// Replace format info bits with correct values
h(b,n,o),{modules:b,version:t,errorCorrectionLevel:n,maskPattern:o,segments:g})}(e,n,y,g)}},{"4cf6a8173d9f3a2":"2iHLf","2ad62f61c352884c":"kU8Fo","87d5a6270eb1dc26":"dvmjt","91abc94f777368cc":"4koKB","9737c3939ab85d95":"2m37T",cee3d371e219e45e:"9BWaM","8700c8c682afabf3":"2hy8U","65ad903a6ba3e":"ivpAq","1e8e447afb4d169c":"ixGQe","8a4a19af97836d80":"61NkN","26720f9d94c9e268":"4DCia","7b6429a248ecc51f":"2XDDf","1368d0fa14524351":"kBoY1"}],"2iHLf":[function(e,t,n){let a;let o=[0,26,44,70,100,134,172,196,242,292,346,404,466,532,581,655,733,815,901,991,1085,1156,1258,1364,1474,1588,1706,1828,1921,2051,2185,2323,2465,2611,2761,2876,3034,3196,3362,3532,3706];/**
