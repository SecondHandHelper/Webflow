...
if(console.log("sellItemMainAuthenticated "+new Date),"draft"!==m.type&&"resell"!==m.type&&(document.getElementById("saveItemDraftButton").style.display="flex"),window.addEventListener("beforeunload",()=>{m.id&&localStorage.removeItem("newItem")}),// Visa alla "viktiga" fält om man är inloggad
