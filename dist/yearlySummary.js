...
})({"nNiw5":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "7ed87e83b36a37a4";
"use strict";
...
},{}],"2tRRE":[function(require,module,exports,__globalThis) {
async function main() {
    const params = getParamsObject();
    mainHeading.innerText = `Tack f\xf6r ${params.year}!`;
    ...
    if (yearlyData.sold) {
        ...
        if (yearlyData.name) document.getElementById('letterTitle').innerHTML = yearlyData.name.charAt(0).toUpperCase() + yearlyData.name.slice(1) + `${params.year === '2023' ? ',' : ''}`;
        else document.getElementById('letterTitle').style.display = 'none';
        document.getElementById('letterBody').innerText = yearlyData.letter + `${params.year === '2023' ? "\n\nTillsammans ser vi till att plaggen f\xe5r komma till anv\xe4ndning, och vi hoppas vi f\xe5r f\xf6rtroendet att forts\xe4tta s\xe4lja dina kl\xe4der under 2024!" : ''}`;
        ...
        if (params.year === '2024') document.getElementById('letterEnding').style.display = 'none';
    }
}
...
},{}]},["nNiw5","2tRRE"], "2tRRE", "parcelRequire81ca")
