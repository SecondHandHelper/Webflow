...
})({"jBp9X":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 50619;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "a34f046c0df5b488";
"use strict";
...
},{}],"iFrO3":[function(require,module,exports) {
...
function loadRecentlySold() {
    ...
    recentlySoldItems.then((result)=>{
        ...
        for (const item of result.data){
            if (isBrandLook2 && !item.frontImageOkForPublish) continue;
            const brand = item.brand;
            const cardSubtitle = item.brand;
            let cardTitle = item.category;
            if (item.cleanedModel) cardTitle = `${item.cleanedModel}${item.category && brand === "Filippa K" ? `, ${item.category}` : ""}`;
            ...
            if (soldPrice >= 180 || daysToSold <= 20) {
                ...
                if (isBrandLook2) itemCardHTML = `<div class="div-block-14-${brand === "Filippa K" ? "super-" : ""}big"><div class="ratio-box _16-9"><div class="content-block with-image">
                ...
                const desktopCardHTML = itemCardHTML.replace("14-big", "14-big-desktop").replace("14-super-big", "14-big-desktop");
                itemListRecentlySoldStartPageDesktop.innerHTML += desktopCardHTML;
                itemsDisplayed++;
            }
        }
        if (isBrandLook2) itemListRecentlySoldStartPage.innerHTML += `<div class="div-block-14-super-big"><div class="ratio-box _16-9"><div class="content-block with-image">
...
async function fetchAndLoadRecentlyAddedItems() {
    try {
        ...
        for (const item of response.data){
            ...
            if (isBrandLook2) itemCardHTML = `<div class="div-block-14-super-big"><a href="${item.url}"/><div class="ratio-box _16-9"><div class="conten-block with-image">
                        <div class="img-container" style="background-image: url('${item.image}')"></div></div></div>
                        <div class="recently-added-text-block">
        ...
        if (isBrandLook2) itemList.innerHTML += `<div class="div-block-14-super-big"><div class="ratio-box _16-9"><div class="content-block with-image">
                        <a href="https://shop.maiapp.se/collections/${brandPartners[brand].maiShopPath}" class="see-more-items-button">Uppt\xe4ck mer</a>  
                        </div></div>`;
    } catch (e) {
...
document.getElementById("sellItemCtaButton").addEventListener("click", ()=>(0, _general.channelRouter)("/sell-item"));
document.getElementById("sellWithMaiCarouselButton").addEventListener("click", ()=>(0, _general.channelRouter)("/sell-item"));
document.getElementById("sellStickyHeaderButton").addEventListener("click", ()=>(0, _general.channelRouter)("/sell-item"));
document.getElementById("darkOverlay").addEventListener("click", ()=>(0, _general.hideChannelBottomSheet)());
document.getElementById("closeChannelBottomSheet").addEventListener("click", ()=>(0, _general.hideChannelBottomSheet)());
...
},{}]},["jBp9X","iFrO3"], "iFrO3", "parcelRequire81ca")
