...
})({"a7hmS":[function(require,module,exports,__globalThis) {
...
},{}],"iFrO3":[function(require,module,exports,__globalThis) {
...
openIds.forEach((id)=>{
    ...
    if (button) button.addEventListener('click', ()=>(0, _general.channelRouter)('/sell-item'));
});
const closeIds = [
    'darkOverlay',
...
closeIds.forEach((id)=>{
    ...
    if (element) element.addEventListener('click', ()=>(0, _general.hideChannelBottomSheet)());
});
...
},{}]},["a7hmS","iFrO3"], "iFrO3", "parcelRequire81ca")
