...
let i=a.getSymbolTotalCodewords(t),l=c.getTotalCodewordsCount(t,n),s=i-l,d=c.getBlocksCount(t,n),m=i%d,g=d-m,f=Math.floor(i/d),y=Math.floor(s/d),p=y+1,h=f-y,I=new u(h),S=0,B=Array(d),v=Array(d),E=0,x=new Uint8Array(e.buffer);// Divide the buffer into the required number of blocks
...
for(o=0;o<E;o++)for(r=0;r<d;r++)o<B[r].length&&(b[k++]=B[r][o]);// Apped EC codewords
