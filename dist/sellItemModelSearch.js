...
})({"3ur56":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 50619;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "72f26d1bae38cef3";
"use strict";
...
},{}],"a9ry4":[function(require,module,exports) {
...
},{"./sellItem":"edX6B","./sellItemHelpers":"8xEoj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"edX6B":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
async function getAndSaveValuation(itemId, item) {
    ...
    try {
        const res = await callBackendApi("/api/valuation", {
            data: {
                itemId,
                item
            },
...
async function detectAndFillBrandModelMaterialAndSize(imageUrl) {
    try {
        ...
        if (!document.querySelector("#itemBrand").value.length && response.data?.brand) {
            ...
            await (0, _sellItemModelSearch.displayFindModelDiv)(response.data.brand);
        ...
        if (!document.getElementById("itemModel").value.length && response.data?.model) {
            ...
            if (isBrandPartner(formBrandValue) && response.data.model.brand === formBrandValue) (0, _sellItemModelSearch.showModelSuggestion)(response.data.model);
            else localStorage.setItem("detectedModel", JSON.stringify(response.data.model));
        }
    } catch (e) {
        errorHandler.report(e);
...
async function detectAndFillColor(imageUrl) {
    ...
    try {
        const response = await callBackendApi("/api/images/detectColor", {
            data: {
                imageUrl
            },
            requiresAuth: false
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3ur56","a9ry4"], "a9ry4", "parcelRequire81ca")
