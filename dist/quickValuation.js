...
})({"70NlA":[function(require,module,exports) {
...
},{}],"7u85q":[function(require,module,exports) {
...
async function getValuation(itemBrand, itemCategory) {
    ...
    try {
        const [valuationRes, platformsRes] = await Promise.all([
            firebase.app().functions("europe-west1").httpsCallable("partialMlValuation")({
                brand,
                category
            }),
            firebase.app().functions("europe-west1").httpsCallable("getPlatformsToBePublishedOn")({
                brand
            })
        ]);
        const { minPrice, maxPrice, decline, humanCheckNeeded, newBrand, newBrandCategory, fewBrand, highPriceVarBrandCategory } = valuationRes.data || {};
        ...
        if (decline) {
            document.getElementById("noValuationText").innerText = `Vi s\xe4ljer generellt sett inte plagg fr\xe5n ${brand} p\xe5 grund av f\xf6r l\xe5g efterfr\xe5ga p\xe5 andrahandsmarknaden.`;
            ...
            document.getElementById("noValuationText").innerText = "Vi kan inte ge en v\xe4rdering f\xf6r att vi inte har s\xe5lt fr\xe5n detta varum\xe4rke innan";
            document.getElementById("noValuationText").style.display = "block";
            document.getElementById("valuationText").style.display = "none";
            document.getElementById("valuationExplanation").style.display = "none";
            document.getElementById("platformsToPublishOn").style.display = "none";
            ...
            if (humanCheckNeeded) {
                if (highPriceVarBrandCategory) {
                    document.getElementById("noValuationText").innerText = "V\xe4rderingen \xe4r mindre s\xe4ker p\xe5 grund av h\xf6g variation inom varum\xe4rket.";
                    document.getElementById("noValuationText").style.display = "block";
                } else if (fewBrand) {
                    document.getElementById("noValuationText").innerText = "V\xe4rderingen \xe4r mindre s\xe4ker d\xe5 vi inte har s\xe5lt s\xe5 mycket av varum\xe4rket.";
                    document.getElementById("noValuationText").style.display = "block";
                }
            }
        ...
        console.log(e);
        document.getElementById("noValuationText").style.display = "block";
        document.getElementById("noValuationText").innerText = "N\xe5got gick fel, f\xf6rs\xf6k igen eller kontakta oss om felet kvarst\xe5r.";
        document.getElementById("valuationExplanation").style.display = "none";
        document.getElementById("valuationText").style.display = "none";
        document.getElementById("platformsToPublishOn").style.display = "none";
    }
...
async function quickValuationMain() {
    ...
    itemBrand.oninput = function() {
        (0, _sellItemHelpers.checkBlockedOrLowShareSoldBrand)(this.value, itemCategory.value);
    };
...
},{"./autocomplete-brands":"aDjZV","./sellItemHelpers":"8xEoj"}],"aDjZV":[function(require,module,exports) {
...
},{}],"8xEoj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["70NlA","7u85q"], "7u85q", "parcelRequire81ca")
