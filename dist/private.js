...
async function privateMain() {
    ...
    if (userId === "3OkW5av20HP8ScpUDS8ip9fBEZr1" && window.location.origin.includes("shh-test")) userId = "3OkW5av20HP8ScpUDS8ip9fBEZr1";
...
function onLoadHandler() {
    ...
    signoutButton.addEventListener("click", (0, _general.signOut));
        ...
        function displayItemCard() {
            ...
            // SOLD - NOT SENT
                ...
                if (shippingMethod === "Pickup") {
                    if (!bagReceived) userActionDiv = getBagReceivedCheckbox(itemId, soldDate, shippingMethod);
          ...
          <a id="changeShippingMethodA-${itemId}" href="#">
            ...
            // SOLD BEFORE
                ...
                youEarnedDiv.innerHTML = `Du har tj\xe4nat ${Math.round(youEarned)} kr`;
            }
        }
    });
...
},{"./general":"lWrRo","./private":"2orDs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["96dpR","2orDs"], "2orDs", "parcelRequire81ca")
