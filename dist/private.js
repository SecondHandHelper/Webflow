...
})({"luvtn":[function(require,module,exports,__globalThis) {
...
async function privateMain() {
  ...
  */ const items = (await callBackendApi('/api/items', {
    ...
    if (user.current?.testUser && user.current?.trustedSellerStatus !== 'Pending' && user.current?.trustedSellerStatusChange && !user.current.trustedSellerStatusChange.seen) {
...
function showTrustedSellerBottomSheet() {
    ...
    if (change === 'pendingToTrusted') {
        ...
        document.getElementById('trustedSellerText').innerText = "Tack vare en h\xf6g andel godk\xe4nda f\xf6rs\xe4ljningar har du nu blivit P\xe5litlig S\xe4ljare! Fr\xe5n och med nu f\xe5r du utbetalt direkt n\xe4r du skickar dina plagg och t\xe4cks av Mais s\xe4ljskydd vid eventuella reklamationer.";
    } else if (change === 'untrustedToTrusted') {
        document.getElementById('trustedSellerTitle').innerText = "Du har uppn\xe5t statusen\nP\xe5litlig S\xe4ljare!";
        document.getElementById('trustedSellerText').innerText = `Tack${user.current?.addressFirstName ? ' ' + user.current.addressFirstName : ''}, f\xf6r att du g\xf6r det enkelt f\xf6r k\xf6pare att handla tryggt i andra hand! Fr\xe5n och med nu f\xe5r du utbetalt direkt n\xe4r du skickar dina plagg och t\xe4cks av Mais s\xe4ljskydd vid eventuella reklamationer.`;
...
},{"./general":"lWrRo","./infoRequestsFunctions":"dW4Oe","./loadItemCards":"ihd5m","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lWrRo":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"dW4Oe":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./general":"lWrRo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ihd5m":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./general":"lWrRo","./private":"2orDs","./sellItemHelpers":"8xEoj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8xEoj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["luvtn","2orDs"], "2orDs", "parcelRequire81ca")
