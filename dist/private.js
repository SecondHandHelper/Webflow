...
})({"hwK2y":[function(require,module,exports,__globalThis) {
...
async function askForAdditionalUserDetails(userID) {
    ...
    let swishNotAvailableUserIds = [
        'l3FdLmp4CHU0tdmGXvVkjx1inr32'
    ];
    ...
    if (oneItemNotPaid && !personalIdExists && !swishNotAvailableUserIds.includes(userID) && (userIsTrustedSeller || oneItemNotPaidAndApproved)) location.href = "/personal-id-form";
}
checkCookie("invite");
...
async function privateMain() {
    ...
    if (user.current?.maiCircle) document.getElementById('headerMaiCircleButton').style.display = 'flex';
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hwK2y","2orDs"], "2orDs", "parcelRequire81ca", {})
