...
})({"96dpR":[function(require,module,exports) {
...
async function privateMain() {
  ...
  */ const items = (await callBackendApi("/api/items", {
    ...
    if (featureIsEnabled("trustedSeller") && user.current?.trustedSellerStatus !== "Pending" && user.current?.trustedSellerStatusChange && !user.current.trustedSellerStatusChange.seen) {
...
function showTrustedSellerBottomSheet() {
    ...
    if (change === "pendingToTrusted" || change === "untrustedToTrusted") {
        document.getElementById("trustedSellerTitle").innerText = "Du har uppn\xe5t statusen P\xe5litlig S\xe4ljare!";
        document.getElementById("trustedSellerText").innerText = `Tack${user.current?.addressFirstName ? " " + user.current.addressFirstName : ""}, f\xf6r att du g\xf6r det enkelt f\xf6r k\xf6pare att handla tryggt i andra hand! Fr\xe5n och med nu f\xe5r du utbetalt direkt n\xe4r du skickar dina plagg.`;
        ...
        document.getElementById("trustedSellerLink").innerText = "Mer om Mais p\xe5litlighets-program";
        document.getElementById("trustedSellerLinkIcon").style.display = "block";
        document.getElementById("trustedSellerTitle").innerText = "Du \xe4r inte en P\xe5litlig S\xe4ljare \xe4nnu - men kan bli fram\xf6ver!";
        document.getElementById("trustedSellerText").innerHTML = `Eftersom en av dina f\xf6rsta f\xf6rs\xe4ljningar har reklamerats eller inte skickats, s\xe5 uppfyller du just nu inte kriterierna f\xf6r en P\xe5litlig S\xe4ljare. Du kan fortfarande s\xe4lja, men har \xe4nnu inte f\xe5tt uppgraderingen till snabbare utbetalningar.<br><br>Genomf\xf6r fler godk\xe4nda f\xf6rs\xe4ljningar f\xf6r att bli en P\xe5litlig S\xe4ljare - vi utv\xe4rderar din status varje m\xe5nad!`;
    } else if (change === "trustedToUntrusted") {
        document.getElementById("trustedSellerButton").style.display = "none";
        document.getElementById("trustedSellerIcon").style.opacity = "0.2";
        document.getElementById("trustedSellerLink").innerText = "Mer om Mais p\xe5litlighets-program";
        document.getElementById("trustedSellerLinkIcon").style.display = "block";
        document.getElementById("trustedSellerTitle").innerText = "Din s\xe4ljarstatus har \xe4ndrats";
        document.getElementById("trustedSellerText").innerText = `Du uppfyller f\xf6r n\xe4rvarande inte kriterierna f\xf6r en P\xe5litlig S\xe4ljare, p\xe5 grund av upprepade  reklamationer eller f\xf6rs\xe4ljningar som inte har skickats. Du kan fortfarande s\xe4lja, men utbetalning kommer ske f\xf6rst n\xe4r f\xf6rs\xe4ljningen godk\xe4nts efter att k\xf6paren h\xe4mtat ut varan.`;
    }
...
function onLoadHandler() {
    ...
    document.getElementById("darkOverlay").addEventListener("click", hideTrustedSellerBottomSheet);
...
},{"./general":"lWrRo","./infoRequestsFunctions":"dW4Oe","./loadItemCards":"ihd5m","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lWrRo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
            ...
            // SOLD - NOT SENT
                ...
                if (!isCanceled) {
                    if (buyerFirstName != null && buyerAddressCity != null && soldPrice) {
                        ...
                        const str = `S\xe5ld till ${buyerFirstName} i ${buyerAddressCity}${brandCollab ? "" : " f\xf6r " + soldPrice + " kr"}`;
                        if (!brandCollab) {
                        ...
                        text3 = brandCollab && item.payoutType !== "Brand Gift Card" ? `\xc4ndra till ${soldPrice} kr i presentkort?` : "";
                    }
...
},{"./general":"lWrRo","./private":"2orDs","./sellItemHelpers":"8xEoj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8xEoj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["96dpR","2orDs"], "2orDs", "parcelRequire81ca")
