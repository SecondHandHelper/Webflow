...
})({"2I7nO":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "d80068e164f63bde";
"use strict";
...
},{}],"70Ecg":[function(require,module,exports,__globalThis) {
var _general = require("./general");
var _cookieManagement = require("./cookieManagement");
async function submitPhotoShootForm() {
    ...
    await db.collection('users').doc(authUser.current.uid).update({
        ...
        (0, _cookieManagement.deleteCookie)('photo_invite');
    }).catch((error)=>{
...
},{"./general":"lWrRo","./cookieManagement":"aifPv"}],"lWrRo":[function(require,module,exports,__globalThis) {
...
},{}],"aifPv":[function(require,module,exports,__globalThis) {
...
},{}]},["2I7nO","70Ecg"], "70Ecg", "parcelRequire81ca")
