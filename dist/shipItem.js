...
if(l&&"string"==typeof t)return l(t);var u=Error("Cannot find module '"+t+"'");throw u.code="MODULE_NOT_FOUND",u}f.resolve=function(n){var r=e[t][1][n];return null!=r?r:n},f.cache={};var c=s[t]=new d.Module(t);e[t][0].call(c.exports,f,c,c.exports,this)}return s[t].exports;function f(e){var t=f.resolve(e);return!1===t?{}:d(t)}}d.isParcelRequire=!0,d.Module=function(e){this.id=e,this.bundle=d,this.exports={}},d.modules=e,d.cache=s,d.parent=a,d.register=function(t,n){e[t]=[function(e,t){t.exports=n},{}]},Object.defineProperty(d,"root",{get:function(){return i[r]}}),i[r]=d;for(var u=0;u<t.length;u++)d(t[u]);if(n){// Expose entry point to Node, AMD or browser globals
// Based on https://github.com/ForbesLindesay/umd/blob/master/template.js
var c=d(n);// CommonJS
"object"==typeof exports&&"undefined"!=typeof module?module.exports=c:"function"==typeof define&&define.amd?define(function(){return c}):o&&(this[o]=c)}}({fSnW0:[function(e,t,n){var r=e("@parcel/transformer-js/src/esmodule-helpers.js"),o=e("./general"),i=e("qrcode"),a=r.interopDefault(i);let s=getParamsObject();if(s.app){let e=document.querySelectorAll(".goback");e.forEach(e=>{e.style.visibility="hidden"})}if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))// Load item
authUser.whenSet(()=>{var e;e=s.id,console.log(`loadItem(${e})`),db.collection("items").doc(e).get().then(e=>{if(e.exists){let t;console.log("Item data:",e.data());let n=e.data(),r=n.brand,i=(0,o.itemCoverImage)(n),a=n.category?n.category:"",s=n.postnordQrCode,l=n.postnordQrCodePage,d=n.dhlLicensePlateBarcodeSrc,u=n.dhlLicensePlate,c=n.upsShipmentId,f=n.vestiaireShippingLabel,h=n.buyer?.FirstName||n.buyerFirstName||"",g=n.buyer?.LastName||n.buyerLastName||"";n.buyer?.StreetAddress||n.buyerAddressStreetAddress,n.buyer?.PostalCode||n.buyerAddressPostalCode;let m=n.buyer?.City||n.buyerAddressCity||"",p=n.shippingMethod,y=n.shippingStatus,b=n.soldPlatform,v=n.soldDate;if(v){specificDate=new Date(v);let e=new Date;specificDate.setHours(0,0,0,0),e.setHours(0,0,0,0),t=Math.round((e-specificDate)/864e5)}pageTitleText.innerHTML=`Skicka ${r.trim()}-${a.trim().toLowerCase()}`,buyerAddressDiv.innerHTML=`${h.trim()} ${g.trim()}<br>${m.trim()}`,itemImageDiv.style.backgroundImage=`url('${i}')`,p&&("Service point"===p?(console.log("postnordQrCode",s,typeof s),s&&!("Vestiaire Collective"===b||"Grailed"===b)?(qrCodeImage.style.backgroundImage=`url('${s}')`,postnordQrCodeDiv.href=l,postnordQrCodeDiv.style.display="flex",mainInstructionDiv.style.display="block",howToShipQrDiv.style.display="block"):d&&"Vestiaire Collective"===b?(barcodeImageContainer.innerHTML=`<img src="${d}" alt="barcode" class="image-98">`,dhlBarcodeDiv.style.display="flex",u&&(dhlLicensePlateText.innerHTML=u,dhlLicensePlateText.style.display="block"),mainInstructionText.innerText="L\xe4mna p\xe5sen till ett ombud och\nbe dem scanna streckkoden",findDhlServicePointLink.style.display="flex",mainInstructionDiv.style.display="block",howToShipDhlBarcodeDiv.style.display="block"):c&&"Vestiaire Collective"===b?(upsIconDiv.style.display="block",findUpsServicePointLink.style.display="flex",mainInstructionText.innerText="S\xe4tt p\xe5 fraktsedeln vi skickat dig p\xe5 p\xe5sen och l\xe4mna till ombud",bullet3TitleNoQr.innerText="L\xe4mna till UPS-ombud",howToShipNoQrDiv.style.display="block",mainInstructionDiv.style.display="block",f&&t>=4&&(openShippingLabelButton.href=f,openShippingLabelButton.style.display="block")):("Grailed"===b?(mainInstructionText.innerText="S\xe4tt p\xe5 fraktsedeln vi skickat dig p\xe5 p\xe5sen och l\xe4mna till ombud",howToShipNoQrDiv.style.display="block"):s||"Vestiaire Collective"===b||"Grailed"===b?mainInstructionText.innerText="N\xe5got har g\xe5tt fel! Skriv till oss, s\xe5 hj\xe4lper vi dig.":(howToShipQrDiv.style.display="block",postnordQrCodeMissingDiv.style.display="flex",mainInstructionText.innerText="Skriv g\xe4rna till oss,\ns\xe5 hj\xe4lper vi dig."),mainInstructionDiv.style.display="block")):"Pickup"===p&&(howToShipPickupDiv.style.display="block",dividerTop.style.display="none")),pageTitleText.style.display="block",p&&"Sent"!==y?contentDiv.style.display="block":(p?"Sent"===y&&(errorMessage.innerHTML="Plagget har skickats!"):errorMessage.innerHTML="Plagget saknar fraktmetod!",errorMessageDiv.style.display="block"),loadingDiv.style.display="none"}else console.log("No such document!")}).catch(e=>{errorHandler.report(e),console.log("Error getting item document:",e)})}),console.log("DO I GET HERE? user.current",user.current),user.current||s.app||(console.log("TOBIAS redirecting to sign-in"),location.href="./sign-in"+window.location.search);else{let e=document.getElementById("qrCanvas");e&&(0,a.default).toCanvas(e,window.location.href,function(e){e&&console.error(e),console.log("success!")})}},{"./general":"1tOWF",qrcode:"6s2CO","@parcel/transformer-js/src/esmodule-helpers.js":"bNgzC"}],"1tOWF":[function(e,t,n){var r=e("@parcel/transformer-js/src/esmodule-helpers.js");async function o(){try{try{// Delete session cookie
...
.slice(0,10)).length)return!1;let t=e.map(e=>Number(e)).reduce((e,t,n)=>(n%2&&(t*=2),t>9&&(t-=9),e+t));return 0==t%10}function l(e){let t=e.replace("-","");return(12!==t.length&&("19"!==t.substring(0,2)||"20"!==t.substring(0,2))&&(t=99>=Number(t.substring(0,2))&&Number(t.substring(0,2))>25?"19"+t:"20"+t),12===t.length)?t:null}function d(e){if(e.images){let t=e.images;return t.modelImageSmall||t.modelImage||t.coverImageSmall||t.coverImage||t.enhancedFrontImageSmall||t.enhancedFrontImage||t.frontImageSmall||t.frontImage}if(e.imagesv2)for(let t of["modelImage","enhancedFrontImage","frontImage"]){let n=e.imagesv2.find(e=>e.name===t);if(n){if(n?.versions?.small)return n.versions.small;if(n?.versions?.medium)return n.versions.medium;if(n?.versions?.large)return n.versions.large;if(n.url)return n.url}}return null}function u(){let e;let t=user.current.referralData.referralCode;if(e=user.current?.maiCircle?"H\xe4r f\xe5r du en exklusiv inbjudan till Mai, som ger en extra fin start med tre kommissionsfria f\xf6rs\xe4ljningar.":"Jag bjuder in dig till Mai f\xf6r att s\xe4lja dina kl\xe4der! G\xe5 genom min l\xe4nk f\xf6r att f\xe5 en extra kommissionsfri f\xf6rs\xe4ljning.",navigator.share)navigator.share({text:e,url:`https://invite.mairesale.com/refer?invite=${t}`}).then(()=>{console.log("Thanks for sharing!")}).catch(e=>{console.error(e),errorHandler.report(e)});else{console.log("Browser doesn't support navigator.share => Copy to clipboard!");let n=e+"\n"+`https://invite.mairesale.com/refer?invite=${t}`;navigator.clipboard.writeText(n),linkCopiedBanner.style.display="flex",setTimeout(function(){linkCopiedBanner.style.display="none"},1500)}}function c(e){isIos?(document.getElementById("continueOnWebBottomSheet").href=window.location.origin+e,document.getElementById("darkOverlay").classList.add("active"),document.getElementById("channelBottomSheet").classList.add("active")):window.location.href!==e&&(window.location.href=e)}function f(){document.getElementById("darkOverlay").classList.remove("active"),document.getElementById("channelBottomSheet").classList.remove("active")}function h(e){e&&(e.preventDefault(),e.stopPropagation());let t=document.getElementById("menu");t&&(t.style.display="block",t.style.transition="opacity 0.3s ease-in-out",t.offsetHeight,t.style.opacity="0",setTimeout(()=>{t.style.display="none"},300))}function g(){let e=document.getElementById("menuLoginButton");e&&e.addEventListener("click",()=>{h(),c("/sign-in")});let t=document.getElementById("menuSellItemButton");t&&t.addEventListener("click",()=>{h(),c("/sell-item")});let n=document.getElementById("menuButton"),r=document.getElementById("closeMenuButton");n&&n.addEventListener("click",function(){let e=document.getElementById("menu");e&&(e.style.display="block",e.style.opacity="0",e.style.transition="opacity 0.3s ease-in-out",e.offsetHeight,e.style.opacity="1")}),r&&r.addEventListener("click",h);let o=document.getElementById("menuChatButton");o&&o.addEventListener("click",()=>{h(),Intercom("show")});let i=document.getElementById("menuFaqButton");i&&i.addEventListener("click",function(e){e.preventDefault(),e.stopPropagation(),h(),setTimeout(()=>{let e=document.getElementById("faq");if(e){let t=e.getBoundingClientRect().top,n=t+window.pageYOffset-50;window.scrollTo({top:n,behavior:"smooth"})}},50)})}function m(e){let t=document.getElementById(e);t&&(// Set initial position below screen
...
setTimeout(()=>{t.style.transform="translateY(0%)"},10),document.getElementById("darkOverlay").classList.add("active"))}function p(e){let t=document.getElementById(e);// Add the visibility check here
...
setTimeout(()=>{t.style.display="none"},300),document.getElementById("darkOverlay").classList.remove("active"))}function y(e){let t=document.getElementById(e);if(t){t.style.display="none";// Check if there are any remaining visible cards
...
r.export(n,"isValidSwedishSsn",()=>s),r.export(n,"formatPersonalId",()=>l),r.export(n,"itemCoverImage",()=>d),r.export(n,"shareCode",()=>u),// Channel bottom sheet
r.export(n,"channelRouter",()=>c),r.export(n,"hideChannelBottomSheet",()=>f),// End of channel bottom sheet
r.export(n,"closeMenuWithAnimation",()=>h),r.export(n,"setupMenuHandlers",()=>g),// Toast animation functions
r.export(n,"animateOpenToast",()=>m),r.export(n,"animateCloseToast",()=>p),r.export(n,"hideInfoRequestCard",()=>y)},{"@parcel/transformer-js/src/esmodule-helpers.js":"bNgzC"}],bNgzC:[function(e,t,n){n.interopDefault=function(e){return e&&e.__esModule?e:{default:e}},n.defineInteropFlag=function(e){Object.defineProperty(e,"__esModule",{value:!0})},n.exportAll=function(e,t){return Object.keys(e).forEach(function(n){"default"===n||"__esModule"===n||t.hasOwnProperty(n)||Object.defineProperty(t,n,{enumerable:!0,get:function(){return e[n]}})}),t},n.export=function(e,t,n){Object.defineProperty(e,t,{enumerable:!0,get:n})}},{}],"6s2CO":[function(e,t,n){let r=e("da1f68cc1fc16077"),o=e("8c6cf49ef2287430"),i=e("8a60cf7722cc14ce"),a=e("f6fcc816b915ba37");function s(e,t,n,i,a){let s=[].slice.call(arguments,1),l=s.length,d="function"==typeof s[l-1];if(!d&&!r())throw Error("Callback required as last argument");if(d){if(l<2)throw Error("Too few arguments provided");2===l?(a=n,n=t,t=i=void 0):3===l&&(t.getContext&&void 0===a?(a=i,i=void 0):(a=i,i=n,n=t,t=void 0))}else{if(l<1)throw Error("Too few arguments provided");return 1===l?(n=t,t=i=void 0):2!==l||t.getContext||(i=n,n=t,t=void 0),new Promise(function(r,a){try{let a=o.create(n,i);r(e(a,t,i))}catch(e){a(e)}})}try{let r=o.create(n,i);a(null,e(r,t,i))}catch(e){a(e)}}n.create=o.create,n.toCanvas=s.bind(null,i.render),n.toDataURL=s.bind(null,i.renderToDataURL),// only svg for now.
...
t.exports=function(){return"function"==typeof Promise&&Promise.prototype&&Promise.prototype.then}},{}],e9qY0:[function(e,t,n){let r=e("4cf6a8173d9f3a2"),o=e("2ad62f61c352884c"),i=e("87d5a6270eb1dc26"),a=e("91abc94f777368cc"),s=e("9737c3939ab85d95"),l=e("cee3d371e219e45e"),d=e("8700c8c682afabf3"),u=e("65ad903a6ba3e"),c=e("1e8e447afb4d169c"),f=e("8a4a19af97836d80"),h=e("26720f9d94c9e268"),g=e("7b6429a248ecc51f"),m=e("1368d0fa14524351");/**
...
y=o.from(t.errorCorrectionLevel,o.M),n=f.from(t.version),h=d.from(t.maskPattern),t.toSJISFunc&&r.setToSJISFunction(t.toSJISFunc)),/**
...
let a=r.getSymbolTotalCodewords(e),s=u.getTotalCodewordsCount(e,t),l=(a-s)*8;// If the bit string is fewer than four bits shorter, add only the number of 0s that
...
let a=r.getSymbolTotalCodewords(t),s=u.getTotalCodewordsCount(t,n),l=a-s,d=u.getBlocksCount(t,n),f=a%d,h=d-f,g=Math.floor(a/d),m=Math.floor(l/d),p=m+1,y=g-m,b=new c(y),v=0,E=Array(d),I=Array(d),B=0,C=new Uint8Array(e.buffer);// Divide the buffer into the required number of blocks
for(let e=0;e<d;e++){let t=e<h?m:p;// extract a block of data from buffer
E[e]=C.slice(v,v+t),// Calculate EC codewords for this data block
I[e]=b.encode(E[e]),v+=t,B=Math.max(B,t)}// Create final data
// Interleave the data and error correction codewords from each block
let w=new Uint8Array(a),x=0;// Add data codewords
for(o=0;o<B;o++)for(i=0;i<d;i++)o<E[i].length&&(w[x++]=E[i][o]);// Apped EC codewords
for(o=0;o<y;o++)for(i=0;i<d;i++)w[x++]=I[i][o];return w}(o,e,t))}(t,n,h),v=r.getSymbolSize(t),E=new a(v);return(// Add function modules
/**
 ...
 * @param  {BitMatrix} matrix  Modules matrix
 * @param  {Number}    version QR Code version
 */function(e,t){let n=e.size,r=l.getPositions(t);for(let t=0;t<r.length;t++){let o=r[t][0],i=r[t][1];for(let t=-1;t<=7;t++)if(!(o+t<=-1)&&!(n<=o+t))for(let r=-1;r<=7;r++)i+r<=-1||n<=i+r||(t>=0&&t<=6&&(0===r||6===r)||r>=0&&r<=6&&(0===t||6===t)||t>=2&&t<=4&&r>=2&&r<=4?e.set(o+t,i+r,!0,!0):e.set(o+t,i+r,!1,!0))}}(E,t),/**
 * Add timing pattern bits to matrix
 *
 * Note: this function must be called before {@link setupAlignmentPattern}
 *
 * @param  {BitMatrix} matrix Modules matrix
 */function(e){let t=e.size;for(let n=8;n<t-8;n++){let t=n%2==0;e.set(n,6,t,!0),e.set(6,n,t,!0)}}(E),/**
 ...
 * @param  {BitMatrix} matrix  Modules matrix
 * @param  {Number}    version QR Code version
 */function(e,t){let n=s.getPositions(t);for(let t=0;t<n.length;t++){let r=n[t][0],o=n[t][1];for(let t=-2;t<=2;t++)for(let n=-2;n<=2;n++)-2===t||2===t||-2===n||2===n||0===t&&0===n?e.set(r+t,o+n,!0,!0):e.set(r+t,o+n,!1,!0)}}(E,t),// Add temporary dummy bits for format info just to set them as reserved.
 ...
 * @param  {BitMatrix} matrix  Modules matrix
 * @param  {Number}    version QR Code version
 */function(e,t){let n,r,o;let i=e.size,a=f.getEncodedBits(t);for(let t=0;t<18;t++)n=Math.floor(t/3),r=t%3+i-8-3,o=(a>>t&1)==1,e.set(n,r,o,!0),e.set(r,n,o,!0)}(E,t),// Add data codewords
/**
 * Add encoded data bits to matrix
 *
 * @param  {BitMatrix}  matrix Modules matrix
 * @param  {Uint8Array} data   Data codewords
 */function(e,t){let n=e.size,r=-1,o=n-1,i=7,a=0;for(let s=n-1;s>0;s-=2)for(6===s&&s--;;){for(let n=0;n<2;n++)if(!e.isReserved(o,s-n)){let r=!1;a<t.length&&(r=(t[a]>>>i&1)==1),e.set(o,s-n,r),-1==--i&&(a++,i=7)}if((o+=r)<0||n<=o){o-=r,r=-r;break}}}(E,b),isNaN(o)&&(o=d.getBestMask(E,p.bind(null,E,n))),// Apply mask pattern
d.applyMask(o,E),// Replace format info bits with correct values
p(E,n,o),{modules:E,version:t,errorCorrectionLevel:n,maskPattern:o,segments:h})}(e,n,y,h)}},{"4cf6a8173d9f3a2":"2iHLf","2ad62f61c352884c":"kU8Fo","87d5a6270eb1dc26":"dvmjt","91abc94f777368cc":"4koKB","9737c3939ab85d95":"2m37T",cee3d371e219e45e:"9BWaM","8700c8c682afabf3":"2hy8U","65ad903a6ba3e":"ivpAq","1e8e447afb4d169c":"ixGQe","8a4a19af97836d80":"61NkN","26720f9d94c9e268":"4DCia","7b6429a248ecc51f":"2XDDf","1368d0fa14524351":"kBoY1"}],"2iHLf":[function(e,t,n){let r;let o=[0,26,44,70,100,134,172,196,242,292,346,404,466,532,581,655,733,815,901,991,1085,1156,1258,1364,1474,1588,1706,1828,1921,2051,2185,2323,2465,2611,2761,2876,3034,3196,3362,3532,3706];/**
...
*/n.getPenaltyN1=function(e){let t=e.size,n=0,o=0,i=0,a=null,s=null;for(let l=0;l<t;l++){o=i=0,a=s=null;for(let d=0;d<t;d++){let t=e.get(l,d);t===a?o++:(o>=5&&(n+=r.N1+(o-5)),a=t,o=1),(t=e.get(d,l))===s?i++:(i>=5&&(n+=r.N1+(i-5)),s=t,i=1)}o>=5&&(n+=r.N1+(o-5)),i>=5&&(n+=r.N1+(i-5))}return n},/**
 ...
 * @param  {Number} y
 * @return {Number}
 */n.mul=function(e,t){return 0===e||0===t?0:r[o[e]+o[t]]}},{}],"61NkN":[function(e,t,n){let r=e("f67b02cdf61cb7c6"),o=e("777da0d92c463f2e"),i=e("acd5b4fcd696edf3"),a=e("5303c314c4a688d7"),s=e("663d0e03da8b2897"),l=r.getBCHDigit(7973);function d(e,t){// Character count indicator + mode indicator bits
...
let i=r.getSymbolTotalCodewords(e),l=o.getTotalCodewordsCount(e,t),u=(i-l)*8;if(n===a.MIXED)return u;let c=u-d(n,e);// Return max number of storable codewords
switch(n){case a.NUMERIC:return Math.floor(c/10*3);case a.ALPHANUMERIC:return Math.floor(c/11*2);case a.KANJI:return Math.floor(c/13);case a.BYTE:default:return Math.floor(c/8)}},/**
...
return(n<<10|i)^21522}},{eeca831a42e85d6c:"2iHLf"}],kBoY1:[function(e,t,n){let r=e("45f6d4bff9d2fc72"),o=e("73109cbf4f3c309d"),i=e("5320016e34c30467"),a=e("fd16f8f25b581951"),s=e("8a7b84039f1cf0d2"),l=e("79379a3a8f3c26bb"),d=e("66903ca51bd2ea1d"),u=e("3b9f47d541e7d71f");/**
...
if((n=r.from(t,l))!==r.BYTE&&n.bit<l.bit)throw Error('"'+e+'" cannot be encoded with mode '+r.toString(n)+".\n Suggested mode is: "+r.toString(l));switch(n!==r.KANJI||d.isKanjiModeEnabled()||(n=r.BYTE),n){case r.NUMERIC:return new o(e);case r.ALPHANUMERIC:return new i(e);case r.KANJI:return new s(e);case r.BYTE:return new a(e)}}/**
 ...
 * @param  {Number} version QR Code version
 * @return {Array}          Array of segments
 */n.fromString=function(e,t){let o=h(e,d.isKanjiModeEnabled()),i=/**
 ...
 */function(e,t){let n={},o={start:{}},i=["start"];for(let a=0;a<e.length;a++){let s=e[a],l=[];for(let e=0;e<s.length;e++){let d=s[e],u=""+a+e;l.push(u),n[u]={node:d,lastCount:0},o[u]={};for(let e=0;e<i.length;e++){let a=i[e];n[a]&&n[a].node.mode===d.mode?(o[a][u]=g(n[a].lastCount+d.length,d.mode)-g(n[a].lastCount,d.mode),n[a].lastCount+=d.length):(n[a]&&(n[a].lastCount=d.length),o[a][u]=g(d.length,d.mode)+4+r.getCharCountIndicator(d.mode,t)// switch cost
)}}i=l}for(let e=0;e<i.length;e++)o[i[e]].end=0;return{map:o,table:n}}(i,t),s=u.find_path(a.map,"start","end"),l=[];for(let e=1;e<s.length-1;e++)l.push(a.table[s[e]].node);return n.fromArray(l.reduce(function(e,t){let n=e.length-1>=0?e[e.length-1]:null;return n&&n.mode===t.mode?e[e.length-1].data+=t.data:e.push(t),e},[]))},/**
 ...
 * @param  {string} data Input string
 * @return {Array}       Array of segments
 */n.rawSplit=function(e){return n.fromArray(h(e,d.isKanjiModeEnabled()))}},{"45f6d4bff9d2fc72":"2XDDf","73109cbf4f3c309d":"hTs8T","5320016e34c30467":"203uh",fd16f8f25b581951:"f7sIe","8a7b84039f1cf0d2":"1otz8","79379a3a8f3c26bb":"fkiQV","66903ca51bd2ea1d":"2iHLf","3b9f47d541e7d71f":"2Nh6w"}],hTs8T:[function(e,t,n){let r=e("29134b0b0820b091");function o(e){this.mode=r.NUMERIC,this.data=e.toString()}o.getBitsLength=function(e){return 10*Math.floor(e/3)+(e%3?e%3*3+1:0)},o.prototype.getLength=function(){return this.data.length},o.prototype.getBitsLength=function(){return o.getBitsLength(this.data.length)},o.prototype.write=function(e){let t,n;// The input data string is divided into groups of three digits,
...
u=f[a],(void 0===f[a]||u>d)&&(f[a]=d,h.push(a,d),c[a]=i));if(void 0!==n&&void 0===f[n])throw Error(["Could not find a path from ",t," to ",n,"."].join(""));return c},extract_shortest_path_from_predecessor_list:function(e,t){for(var n=[],r=t;r;)n.push(r),e[r],r=e[r];return n.reverse(),n},find_path:function(e,t,n){var o=r.single_source_shortest_paths(e,t,n);return r.extract_shortest_path_from_predecessor_list(o,n)},/**
   ...
   */PriorityQueue:{make:function(e){var t,n=r.PriorityQueue,o={};for(t in e=e||{},n)n.hasOwnProperty(t)&&(o[t]=n[t]);return o.queue=[],o.sorter=e.sorter||n.default_sorter,o},default_sorter:function(e,t){return e.cost-t.cost},/**
     ...
     */pop:function(){return this.queue.shift()},empty:function(){return 0===this.queue.length}}};t.exports=r},{}],i1BDL:[function(e,t,n){let r=e("5b3f7c513802d6c7");n.render=function(e,t,n){var o;let i=n,a=t;void 0!==i||t&&t.getContext||(i=t,t=void 0),t||(a=function(){try{return document.createElement("canvas")}catch(e){throw Error("You need to specify a canvas element")}}()),i=r.getOptions(i);let s=r.getImageWidth(e.modules.size,i),l=a.getContext("2d"),d=l.createImageData(s,s);return r.qrToImageData(d.data,e,i),o=a,l.clearRect(0,0,o.width,o.height),o.style||(o.style={}),o.height=s,o.width=s,o.style.height=s+"px",o.style.width=s+"px",l.putImageData(d,0,0),a},n.renderToDataURL=function(e,t,r){let o=r;void 0!==o||t&&t.getContext||(o=t,t=void 0),o||(o={});let i=n.render(e,t,o),a=o.type||"image/png",s=o.rendererOpts||{};return i.toDataURL(a,s.quality)}},{"5b3f7c513802d6c7":"3YBlJ"}],"3YBlJ":[function(e,t,n){function r(e){if("number"==typeof e&&(e=e.toString()),"string"!=typeof e)throw Error("Color should be defined as hex string");let t=e.slice().replace("#","").split("");if(t.length<3||5===t.length||t.length>8)throw Error("Invalid hex color: "+e);(3===t.length||4===t.length)&&(t=Array.prototype.concat.apply([],t.map(function(e){return[e,e]}))),6===t.length&&t.push("F","F");let n=parseInt(t.join(""),16);return{r:n>>24&255,g:n>>16&255,b:n>>8&255,a:255&n,hex:"#"+t.slice(0,6).join("")}}n.getOptions=function(e){e||(e={}),e.color||(e.color={});let t=void 0===e.margin||null===e.margin||e.margin<0?4:e.margin,n=e.width&&e.width>=21?e.width:void 0,o=e.scale||4;return{width:n,scale:n?4:o,margin:t,color:{dark:r(e.color.dark||"#000000ff"),light:r(e.color.light||"#ffffffff")},type:e.type,rendererOpts:e.rendererOpts||{}}},n.getScale=function(e,t){return t.width&&t.width>=e+2*t.margin?t.width/(e+2*t.margin):t.scale},n.getImageWidth=function(e,t){let r=n.getScale(e,t);return Math.floor((e+2*t.margin)*r)},n.qrToImageData=function(e,t,r){let o=t.modules.size,i=t.modules.data,a=n.getScale(o,r),s=Math.floor((o+2*r.margin)*a),l=r.margin*a,d=[r.color.light,r.color.dark];for(let t=0;t<s;t++)for(let n=0;n<s;n++){let u=(t*s+n)*4,c=r.color.light;if(t>=l&&n>=l&&t<s-l&&n<s-l){let e=Math.floor((t-l)/a),r=Math.floor((n-l)/a);c=d[i[e*o+r]?1:0]}e[u++]=c.r,e[u++]=c.g,e[u++]=c.b,e[u]=c.a}}},{}],"8CcR1":[function(e,t,n){let r=e("c36bbcf663291acc");function o(e,t){let n=e.a/255,r=t+'="'+e.hex+'"';return n<1?r+" "+t+'-opacity="'+n.toFixed(2).slice(1)+'"':r}function i(e,t,n){let r=e+t;return void 0!==n&&(r+=" "+n),r}n.render=function(e,t,n){let a=r.getOptions(t),s=e.modules.size,l=e.modules.data,d=s+2*a.margin,u=a.color.light.a?"<path "+o(a.color.light,"fill")+' d="M0 0h'+d+"v"+d+'H0z"/>':"",c="<path "+o(a.color.dark,"stroke")+' d="'+function(e,t,n){let r="",o=0,a=!1,s=0;for(let l=0;l<e.length;l++){let d=Math.floor(l%t),u=Math.floor(l/t);d||a||(a=!0),e[l]?(s++,l>0&&d>0&&e[l-1]||(r+=a?i("M",d+n,.5+u+n):i("m",o,0),o=0,a=!1),d+1<t&&e[l+1]||(r+=i("h",s),s=0)):o++}return r}(l,s,a.margin)+'"/>',f=a.width?'width="'+a.width+'" height="'+a.width+'" ':"",h='<svg xmlns="http://www.w3.org/2000/svg" '+f+('viewBox="0 0 '+d)+" "+d+'" shape-rendering="crispEdges">'+u+c+"</svg>\n";return"function"==typeof n&&n(null,h),h}},{c36bbcf663291acc:"3YBlJ"}]},["fSnW0"],"fSnW0","parcelRequire81ca")//# sourceMappingURL=shipItem.js.map
;
