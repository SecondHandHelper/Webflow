...
setTimeout(()=>{t.style.display="none"},300),document.getElementById("darkOverlay").classList.remove("active"))}function b(e){let t=document.getElementById(e);if(t){t.style.display="none";// Check if there are any remaining visible cards
...
r.export(n,"isValidSwedishSsn",()=>s),r.export(n,"formatPersonalId",()=>l),r.export(n,"itemCoverImage",()=>d),r.export(n,"shareCode",()=>c),// Channel bottom sheet
r.export(n,"channelRouter",()=>u),r.export(n,"hideChannelBottomSheet",()=>f),// End of channel bottom sheet
r.export(n,"closeMenuWithAnimation",()=>g),r.export(n,"prepareMenu",()=>h),r.export(n,"setupMenuHandlers",()=>m),// Toast animation functions
r.export(n,"animateOpenToast",()=>p),r.export(n,"animateCloseToast",()=>y),r.export(n,"hideInfoRequestCard",()=>b),// Make prepareMenu available globally for session cookie auto-login
window.prepareMenu=h},{"@parcel/transformer-js/src/esmodule-helpers.js":"bNgzC"}],bNgzC:[function(e,t,n){n.interopDefault=function(e){return e&&e.__esModule?e:{default:e}},n.defineInteropFlag=function(e){Object.defineProperty(e,"__esModule",{value:!0})},n.exportAll=function(e,t){return Object.keys(e).forEach(function(n){"default"===n||"__esModule"===n||t.hasOwnProperty(n)||Object.defineProperty(t,n,{enumerable:!0,get:function(){return e[n]}})}),t},n.export=function(e,t,n){Object.defineProperty(e,t,{enumerable:!0,get:n})}},{}],"6s2CO":[function(e,t,n){let r=e("da1f68cc1fc16077"),o=e("8c6cf49ef2287430"),i=e("8a60cf7722cc14ce"),a=e("f6fcc816b915ba37");function s(e,t,n,i,a){let s=[].slice.call(arguments,1),l=s.length,d="function"==typeof s[l-1];if(!d&&!r())throw Error("Callback required as last argument");if(d){if(l<2)throw Error("Too few arguments provided");2===l?(a=n,n=t,t=i=void 0):3===l&&(t.getContext&&void 0===a?(a=i,i=void 0):(a=i,i=n,n=t,t=void 0))}else{if(l<1)throw Error("Too few arguments provided");return 1===l?(n=t,t=i=void 0):2!==l||t.getContext||(i=n,n=t,t=void 0),new Promise(function(r,a){try{let a=o.create(n,i);r(e(a,t,i))}catch(e){a(e)}})}try{let r=o.create(n,i);a(null,e(r,t,i))}catch(e){a(e)}}n.create=o.create,n.toCanvas=s.bind(null,i.render),n.toDataURL=s.bind(null,i.renderToDataURL),// only svg for now.
...
t.exports=function(){return"function"==typeof Promise&&Promise.prototype&&Promise.prototype.then}},{}],e9qY0:[function(e,t,n){let r=e("4cf6a8173d9f3a2"),o=e("2ad62f61c352884c"),i=e("87d5a6270eb1dc26"),a=e("91abc94f777368cc"),s=e("9737c3939ab85d95"),l=e("cee3d371e219e45e"),d=e("8700c8c682afabf3"),c=e("65ad903a6ba3e"),u=e("1e8e447afb4d169c"),f=e("8a4a19af97836d80"),g=e("26720f9d94c9e268"),h=e("7b6429a248ecc51f"),m=e("1368d0fa14524351");/**
...
let a=r.getSymbolTotalCodewords(t),s=c.getTotalCodewordsCount(t,n),l=a-s,d=c.getBlocksCount(t,n),f=a%d,g=d-f,h=Math.floor(a/d),m=Math.floor(l/d),p=m+1,y=h-m,b=new u(y),v=0,E=Array(d),I=Array(d),B=0,w=new Uint8Array(e.buffer);// Divide the buffer into the required number of blocks
for(let e=0;e<d;e++){let t=e<g?m:p;// extract a block of data from buffer
E[e]=w.slice(v,v+t),// Calculate EC codewords for this data block
I[e]=b.encode(E[e]),v+=t,B=Math.max(B,t)}// Create final data
// Interleave the data and error correction codewords from each block
let C=new Uint8Array(a),x=0;// Add data codewords
for(o=0;o<B;o++)for(i=0;i<d;i++)o<E[i].length&&(C[x++]=E[i][o]);// Apped EC codewords
for(o=0;o<y;o++)for(i=0;i<d;i++)C[x++]=I[i][o];return C}(o,e,t))}(t,n,g),v=r.getSymbolSize(t),E=new a(v);return(// Add function modules
/**
...
let i=r.getSymbolTotalCodewords(e),l=o.getTotalCodewordsCount(e,t),c=(i-l)*8;if(n===a.MIXED)return c;let u=c-d(n,e);// Return max number of storable codewords
...
return(n<<10|i)^21522}},{eeca831a42e85d6c:"2iHLf"}],kBoY1:[function(e,t,n){let r=e("45f6d4bff9d2fc72"),o=e("73109cbf4f3c309d"),i=e("5320016e34c30467"),a=e("fd16f8f25b581951"),s=e("8a7b84039f1cf0d2"),l=e("79379a3a8f3c26bb"),d=e("66903ca51bd2ea1d"),c=e("3b9f47d541e7d71f");/**
 ...
 */function h(e,t){switch(t){case r.NUMERIC:return o.getBitsLength(e);case r.ALPHANUMERIC:return i.getBitsLength(e);case r.KANJI:return s.getBitsLength(e);case r.BYTE:return a.getBitsLength(e)}}/**
 ...
 */function(e,t){let n={},o={start:{}},i=["start"];for(let a=0;a<e.length;a++){let s=e[a],l=[];for(let e=0;e<s.length;e++){let d=s[e],c=""+a+e;l.push(c),n[c]={node:d,lastCount:0},o[c]={};for(let e=0;e<i.length;e++){let a=i[e];n[a]&&n[a].node.mode===d.mode?(o[a][c]=h(n[a].lastCount+d.length,d.mode)-h(n[a].lastCount,d.mode),n[a].lastCount+=d.length):(n[a]&&(n[a].lastCount=d.length),o[a][c]=h(d.length,d.mode)+4+r.getCharCountIndicator(d.mode,t)// switch cost
...
var o,i,a,s,l,d,c,u={},f={};f[t]=0;// Costs of shortest paths from s to all nodes encountered; differs from
...
(o=g.pop()).value,s=o.cost,// Get nodes adjacent to u...
