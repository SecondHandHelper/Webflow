 ...
 */function m(e,t,n){let r,o;let i=e.size,a=h.getEncodedBits(t,n);for(r=0;r<15;r++)o=(a>>r&1)==1,r<6?e.set(r,8,o,!0):r<8?e.set(r+1,8,o,!0):e.set(i-15+r,8,o,!0),r<8?e.set(8,i-r-1,o,!0):r<9?e.set(8,15-r-1+1,o,!0):e.set(8,15-r-1,o,!0);// fixed module
e.set(i-8,8,1,!0)}/**
 * QR Code
 *
 ...
 */function(e,t,n,o){let h;if(Array.isArray(e))h=p.fromArray(e);else if("string"==typeof e){let r=t;if(!r){let t=p.rawSplit(e);// Estimate best version that can contain raw splitted segments
r=f.getBestVersionForData(t,n)}// Build optimized segments
// If estimated version is undefined, try with the highest version
h=p.fromString(e,r||40)}else throw Error("Invalid data");// Get the min version that can contain data
...
let a=r.getSymbolTotalCodewords(t),s=u.getTotalCodewordsCount(t,n),l=a-s,d=u.getBlocksCount(t,n),f=a%d,h=d-f,g=Math.floor(a/d),p=Math.floor(l/d),m=p+1,y=g-p,b=new c(y),v=0,E=Array(d),I=Array(d),C=0,w=new Uint8Array(e.buffer);// Divide the buffer into the required number of blocks
for(let e=0;e<d;e++){let t=e<h?p:m;// extract a block of data from buffer
E[e]=w.slice(v,v+t),// Calculate EC codewords for this data block
I[e]=b.encode(E[e]),v+=t,C=Math.max(C,t)}// Create final data
// Interleave the data and error correction codewords from each block
let B=new Uint8Array(a),x=0;// Add data codewords
for(o=0;o<C;o++)for(i=0;i<d;i++)o<E[i].length&&(B[x++]=E[i][o]);// Apped EC codewords
for(o=0;o<y;o++)for(i=0;i<d;i++)B[x++]=I[i][o];return B}(o,e,t))}(t,n,h),v=r.getSymbolSize(t),E=new a(v);return(// Add function modules
/**
 ...
 */function p(e,t){let n;let l=r.getBestModeForData(e);// Make sure data can be encoded
