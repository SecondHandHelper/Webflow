...
let a=r.getSymbolTotalCodewords(t),s=u.getTotalCodewordsCount(t,n),l=a-s,d=u.getBlocksCount(t,n),f=a%d,h=d-f,g=Math.floor(a/d),m=Math.floor(l/d),p=m+1,y=g-m,b=new c(y),v=0,E=Array(d),I=Array(d),C=0,w=new Uint8Array(e.buffer);// Divide the buffer into the required number of blocks
