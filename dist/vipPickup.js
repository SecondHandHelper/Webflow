...
y=o.from(t.errorCorrectionLevel,o.M),n=f.from(t.version),h=c.from(t.maskPattern),t.toSJISFunc&&r.setToSJISFunction(t.toSJISFunc)),/**
...
let a=r.getSymbolTotalCodewords(t),s=u.getTotalCodewordsCount(t,n),l=a-s,c=u.getBlocksCount(t,n),f=a%c,h=c-f,g=Math.floor(a/c),m=Math.floor(l/c),p=m+1,y=g-m,v=new d(y),E=0,b=Array(c),B=Array(c),I=0,w=new Uint8Array(e.buffer);// Divide the buffer into the required number of blocks
for(let e=0;e<c;e++){let t=e<h?m:p;// extract a block of data from buffer
b[e]=w.slice(E,E+t),// Calculate EC codewords for this data block
B[e]=v.encode(b[e]),E+=t,I=Math.max(I,t)}// Create final data
// Interleave the data and error correction codewords from each block
let C=new Uint8Array(a),A=0;// Add data codewords
for(o=0;o<I;o++)for(i=0;i<c;i++)o<b[i].length&&(C[A++]=b[i][o]);// Apped EC codewords
for(o=0;o<y;o++)for(i=0;i<c;i++)C[A++]=B[i][o];return C}(o,e,t))}(t,n,h),E=r.getSymbolSize(t),b=new a(E);return(// Add function modules
/**
 ...
 * @param  {Number} version QR Code version
 * @return {Array}          Array of segments
 */n.fromString=function(e,t){let o=h(e,c.isKanjiModeEnabled()),i=/**
 ...
 */function(e,t){let n={},o={start:{}},i=["start"];for(let a=0;a<e.length;a++){let s=e[a],l=[];for(let e=0;e<s.length;e++){let c=s[e],u=""+a+e;l.push(u),n[u]={node:c,lastCount:0},o[u]={};for(let e=0;e<i.length;e++){let a=i[e];n[a]&&n[a].node.mode===c.mode?(o[a][u]=g(n[a].lastCount+c.length,c.mode)-g(n[a].lastCount,c.mode),n[a].lastCount+=c.length):(n[a]&&(n[a].lastCount=c.length),o[a][u]=g(c.length,c.mode)+4+r.getCharCountIndicator(c.mode,t)// switch cost
 ...
 * @param  {string} data Input string
 * @return {Array}       Array of segments
 */n.rawSplit=function(e){return n.fromArray(h(e,c.isKanjiModeEnabled()))}},{"45f6d4bff9d2fc72":"2XDDf","73109cbf4f3c309d":"hTs8T","5320016e34c30467":"203uh",fd16f8f25b581951:"f7sIe","8a7b84039f1cf0d2":"1otz8","79379a3a8f3c26bb":"fkiQV","66903ca51bd2ea1d":"2iHLf","3b9f47d541e7d71f":"2Nh6w"}],hTs8T:[function(e,t,n){let r=e("29134b0b0820b091");function o(e){this.mode=r.NUMERIC,this.data=e.toString()}o.getBitsLength=function(e){return 10*Math.floor(e/3)+(e%3?e%3*3+1:0)},o.prototype.getLength=function(){return this.data.length},o.prototype.getBitsLength=function(){return o.getBitsLength(this.data.length)},o.prototype.write=function(e){let t,n;// The input data string is divided into groups of three digits,
