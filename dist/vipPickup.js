...
let a=r.getSymbolTotalCodewords(t),s=u.getTotalCodewordsCount(t,n),l=a-s,c=u.getBlocksCount(t,n),f=a%c,h=c-f,g=Math.floor(a/c),m=Math.floor(l/c),p=m+1,y=g-m,v=new d(y),E=0,b=Array(c),I=Array(c),B=0,w=new Uint8Array(e.buffer);// Divide the buffer into the required number of blocks
...
for(o=0;o<y;o++)for(i=0;i<c;i++)C[A++]=I[i][o];return C}(o,e,t))}(t,n,h),E=r.getSymbolSize(t),b=new a(E);return(// Add function modules
/**
